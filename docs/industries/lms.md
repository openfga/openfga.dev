...
| Course → class hierarchy       | [parent-child relationships](https://openfga.dev/docs/modeling/parent-child.md)                       |
...
| Multi-tenant LMS SaaS          | tenant-scoped types, see [multi-tenant SaaS](https://openfga.dev/docs/use-cases/multi-tenant-saas.md) |
...
- **Time-bounded enrollment.** Use [conditions](https://openfga.dev/docs/modeling/conditions.md) to expire student access at the end of a term without rewriting tuples.
...
Schema, sample tuples, and assertions are in [openfga/sample-stores/stores/lms](https://github.com/openfga/sample-stores/tree/main/stores/lms). For the broader pattern of "role at the org, scoped relationships per record", see [Modeling Roles](https://openfga.dev/docs/best-practices/modeling-roles.md).
