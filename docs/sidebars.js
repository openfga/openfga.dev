...
const sidebars = {
  docs: [
    ...
    },
    {
      type: 'doc',
      label: 'Alternatives',
      id: 'content/alternatives/overview',
    },
    {
      type: 'category',
      collapsible: true,
      collapsed: true,
      label: 'Compare',
      link: { type: 'doc', id: 'content/compare/overview' },
      items: [
        { type: 'doc', label: 'OpenFGA vs SpiceDB', id: 'content/compare/spicedb' },
        { type: 'doc', label: 'OpenFGA vs Cerbos', id: 'content/compare/cerbos' },
        { type: 'doc', label: 'OpenFGA vs Permit.io', id: 'content/compare/permit' },
        { type: 'doc', label: 'OpenFGA vs Oso', id: 'content/compare/oso' },
        { type: 'doc', label: 'OpenFGA vs Ory Keto', id: 'content/compare/keto' },
        { type: 'doc', label: 'OpenFGA vs OPA', id: 'content/compare/opa' },
        { type: 'doc', label: 'OpenFGA vs WorkOS FGA', id: 'content/compare/workos' },
        { type: 'doc', label: 'OpenFGA vs Keycloak', id: 'content/compare/keycloak' },
        { type: 'doc', label: 'OpenFGA vs Auth0 FGA', id: 'content/compare/auth0-fga' },
      ],
    },
  ],
};
