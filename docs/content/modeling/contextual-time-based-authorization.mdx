...
- A <ProductConcept section="what-are-contextual-tuples" linkName="Conceptual Tuple" />: a tuple that can be added to a check request, and only exist within the context of that particular request.
