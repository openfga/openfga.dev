...
- A <ProductConcept section="what-is-a-relation" linkName="Relation" />: is a string defined in the type definition of an authorization model that defines the possibility of a relationship between objects of this type and other types.
...
Anne can view transaction:A because she is an account manager whose account is at the same branch.
<CheckRequestViewer user={'anne'} relation={'can_view'} object={'transaction:A'} allowed={true} />

Caroline can view transaction:A because she is the customer and the transaction is tied to her account.
<CheckRequestViewer user={'caroline'} relation={'can_view'} object={'transaction:A'} allowed={true} />
...
/>
<CheckRequestViewer user={'mary'} relation={'can_view'} object={'transaction:A'} allowed={false} />
