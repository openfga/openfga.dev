...
Use the [OpenFGA Model Testing Action](https://github.com/marketplace/actions/openfga-model-testing-action) to running tests from CI/CD flows in GitHub.

Point the `store-file-path` parameter to the `.fga.yaml` file to when configuring the action:
