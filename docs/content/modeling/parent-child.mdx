...
- [Union Operator](../modeling-language.mdx#the-union-operator): the union operator can be used to indicate that the user has multiple ways of being related to an object
...
See [Referencing Relations on Related Objects](../modeling-language.mdx#referencing-relations-on-related-objects) for more.
:::
