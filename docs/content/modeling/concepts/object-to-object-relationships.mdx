---
sidebar_position: 2
slug: /modeling/concepts/object-to-object-relationships
---
...
You need to know how to add users to groups and grant groups access to resources. [Learn more →](../basics/user-groups.mdx)
...
Object to object can be used for more advanced use case, such as [entitlements](../advanced/patterns/entitlements.mdx). An example use case is to allow subscribers to be entitled to different plans.
