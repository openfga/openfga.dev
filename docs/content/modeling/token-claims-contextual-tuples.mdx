...
- Are only supported on the <UpdateProductNameInLinks link="https://openfga.dev/api-reference/relationship-queries/check-whether-a-user-is-authorized-to-access-an-object" name="Check API endpoint" />, <UpdateProductNameInLinks link="https://openfga.dev/api-reference/relationship-queries/list-all-objects-of-the-given-type-that-the-user-has-a-relation-with" name="ListObjects API endpoint" /> and <UpdateProductNameInLinks link="https://openfga.dev/api-reference/relationship-queries/list-the-users-matching-the-provided-filter-who-have-a-certain-relation-to-a-particular-type" name="ListUsers API endpoint" />. They are not supported on read, expand, or other endpoints.
- If you use the <UpdateProductNameInLinks link="https://openfga.dev/api-reference/relationship-tuples/return-a-list-of-all-the-tuple-changes" name="Read Changes API endpoint" /> to build a permission aware search index, it may be difficult to account for contextual tuples.
:::
