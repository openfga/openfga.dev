...
sidebar_position: 3
slug: /modeling/advanced/use-cases/iot
---
...
You need to know how to add users to groups and create relationships between groups of users and an object. [Learn more →](../../concepts/direct-relationships.mdx)
...
<CheckRequestViewer user={'anne'} relation={'live_video_viewer'} object={'device:1'} allowed={true} />

On the other hand, Anne does not have `device_renamer` relationship with device:1.

<CheckRequestViewer user={'anne'} relation={'device_renamer'} object={'device:1'} allowed={false} />
...
<CheckRequestViewer user={'charles'} relation={'live_video_viewer'} object={'device:1'} allowed={true} />
...
<CheckRequestViewer user={'emily'} relation={'live_video_viewer'} object={'device:1'} allowed={false} />
