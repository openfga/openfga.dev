...
:::caution
The original <ProductName format={ProductNameFormat.ShortForm} /> authorization model schema v1.0 is considered deprecated, and support for it is scheduled to be dropped. Read the [deprecation timeline](#deprecation-timeline).
:::
