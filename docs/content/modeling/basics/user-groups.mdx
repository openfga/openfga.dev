---
sidebar_position: 6
slug: /modeling/basics/user-groups
---
  ...
  relatedLinks={[
    {
      ...
      id: '../../writing-data/managing-group-membership.mdx',
    },
    {
      ...
      link: '/modeling/advanced/use-cases/gdrive#02-organization-permissions',
      id: '../advanced/use-cases/gdrive.mdx#02-organization-permissions',
    },
    {
      title: 'Modeling GitHub',
      description: 'Granting teams permissions to a repo in the GitHub use-case.',
      link: '/modeling/advanced/use-cases/github#02-permissions-for-teams-in-an-org',
      id: '../advanced/use-cases/github.mdx#02-permissions-for-teams-in-an-org',
    },
  ]}
/>
