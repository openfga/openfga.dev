---
sidebar_position: 8
slug: /modeling/basics/contextual-time-based-authorization
---
...
- **Modeling Object-to-Object Relationships**: You need to know how to create relationships between objects and how that might affect a user's relationships to those objects. [Learn more →](../concepts/object-to-object-relationships.mdx)
  ...
  relatedLinks={[
    {
      ...
      id: '../concepts/object-to-object-relationships.mdx',
    },
    {
      ...
      link: '/modeling/basics/multiple-restrictions',
