...
sidebar_position: 2
slug: /modeling/configuration-language
---
...
You'll encounter the JSON syntax when calling the API directly or through the [SDKs](../integration), and the DSL when interacting with <ProductName format={ProductNameFormat.ShortForm}/> through the [Playground](https://play.fga.dev/). Throughout the documentation you can switch between the two presentations.

To better understand this guide correctly, you should be familiar with some <ProductConcept /> and [how to get started on modeling](./getting-started.mdx).
...
This `team` _<ProductConcept section="what-is-a-type-definition" linkName="type definitions" />_ defines all _<ProductConcept section="what-is-a-relation" linkName="relations" />_ _<ProductConcept section="what-is-a-user" linkName="users" />_ can have with an _<ProductConcept section="what-is-an-object" linkName="object" />_ of _type_ `team`. In this case the _relations_ is: `member`.

Due to the direct relationship keyword (`self`) being used, this means that a user in the system can have a **<ProductConcept section="what-are-direct-and-implied-relationships" linkName="direct relationship" />** with the `team` type as a `member`.
...
For more examples, take look at [Modeling Concepts: Direct Relationships](../modeling/concepts/direct-relationships.mdx).
...
The above `document` _<ProductConcept section="what-is-a-type-definition" linkName="type definition" />_ defines all the _<ProductConcept section="what-is-a-relation" linkName="relations" />_ _<ProductConcept section="what-is-a-user" linkName="users" />_ can have with an _<ProductConcept section="what-is-an-object" linkName="object" />_ of _type_ `document`. In this case the _relations_ are: `editor`, `viewer` and `can_rename`.
...
- _anne_ is a _viewer_ to _document:new-roadmap_
  <RelationshipTuplesViewer
    relationshipTuples={[
      {
        user: 'anne',
...
For more examples, take a look at [Modeling Concepts: Concentric Relationships](../modeling/concepts/concentric-relationships.mdx), [Modeling Basics: Roles and Permissions](../modeling/basics/roles-and-permissions.mdx) and [Advanced Modeling: Google Drive](../modeling/advanced/use-cases/gdrive.mdx).
...
For more examples, take look at [Modeling Basics: Parent-Child Objects](../modeling/basics/parent-child.mdx), [Advanced Modeling: Google Drive](../modeling/advanced/use-cases/gdrive.mdx), [Advanced Modeling: GitHub](../modeling/advanced/use-cases/github.mdx), and [Advanced Modeling: Entitlements](../modeling/advanced/patterns/entitlements.mdx).
...
For more examples, take a look at [Modeling Concepts: Concentric Relationships](../modeling/concepts/concentric-relationships.mdx), [Modeling Roles and Permissions](../modeling/basics/roles-and-permissions.mdx) and [Advanced Modeling: Modeling for IoT](../modeling/advanced/use-cases/iot.mdx#03-updating-our-authorization-model-to-facilitate-future-changes).
...
For more examples, take look at [Modeling with Multiple Restrictions](./basics/multiple-restrictions.mdx).
...
For more information, see [Modeling Basics: Blocklists](../modeling/basics/blocklists.mdx).
