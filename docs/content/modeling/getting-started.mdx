...
If you want to learn more, you can read further about this in [Modeling User Groups](./basics/user-groups.mdx) and [Managing Relationships Between Objects](../writing-data/managing-relationships-between-objects.mdx).
:::
