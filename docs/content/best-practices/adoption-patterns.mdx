...
This document outlines a few implementation patterns for addressing these issues when implementing <ProductName format={ProductNameFormat.ShortForm}/> in your organization.
