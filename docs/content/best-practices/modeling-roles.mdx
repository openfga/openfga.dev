...
| **Simple Dynamic Roles** | User-defined roles at org level    | Medium     | Medium      | Company Acme creates an 'Auditors' role that is configured to view project information for all projects.        |
