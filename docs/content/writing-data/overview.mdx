---
id: overview
title: 'Write Your Authorization Data'
slug: /writing-data
sidebar_position: 0
---
...
<CardGrid
  bottom={[
    ...
    },
    {
      ...
      to: '/writing-data/managing-group-access',
    },
    {
      title: 'Managing Object Relationships',
      description:
        'Write relationship tuples to manage how two objects are related. E.g. parent folder and child document.',
      to: '/writing-data/managing-relationships-between-objects',
    },
    {
      ...
      to: '/writing-data/transactional-writes',
    },
    {
      title: 'Comparison Between Check, Read And Expand',
      description: 'Comparing when to use check vs. read vs. expand.',
      to: '/writing-data/advanced/check-read-expand',
    },
  ]}
/>
