...
:::info Note
The Consistency parameter is an experimental feature in OpenFGA ([v1.5.7](https://github.com/openfga/openfga/releases/tag/v1.5.7)+) and needs to be enabled with the `enable-consistency-params` parameter, e.g. `openfga run --experimentals enable-consistency-params`.
:::
