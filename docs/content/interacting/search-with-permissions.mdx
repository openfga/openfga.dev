...
1. Call the <UpdateProductNameInLinks link="https://openfga.dev/api-reference/relationship-tuples/return-a-list-of-all-the-tuple-changes" name="{ProductName} changes API" />.
...
1. Call the <UpdateProductNameInLinks link="https://openfga.dev/api-reference/relationship-queries/list-all-objects-of-the-given-type-that-the-user-has-a-relation-with" name="{ProductName} List Objects API" />. to get the list of all resources a user can access.
