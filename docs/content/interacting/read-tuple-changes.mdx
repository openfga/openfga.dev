...
3. You have [configured the _authorization model_](../modeling) and [added some _relationship tuples_](../getting-started/add-tuples.mdx#02-calling-write-api-to-add-new-relationship-tuples).
...
1. <SdkSetupPrerequisite />
2. You have [configured the _authorization model_](../modeling) and [added some _relationship tuples_](../getting-started/add-tuples.mdx#02-calling-write-api-to-add-new-relationship-tuples).
