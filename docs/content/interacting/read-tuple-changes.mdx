...
1. <SdkSetupPrerequisite />
2. You have [configured the _authorization model_](../modeling) and and [added some _relationship tuples_](../getting-started/update-tuples.mdx#02-calling-write-api-to-add-new-relationship-tuples).
