...
The [Check API](https://openfga.dev/api-reference/relationship-queries/check-whether-a-user-is-authorized-to-access-an-object) is an API endpoint that returns whether the user has a certain relationship with an object. <ProductName format={ProductNameFormat.ShortForm}/> will resolve all prerequisite relationships to establish whether a relationship exists.
  ...
  relatedLinks={[
    {
      ...
      link: 'https://openfga.dev/api-reference/relationship-queries/check-whether-a-user-is-authorized-to-access-an-object',
    },
    {
      title: 'Read API Reference',
      description: 'Official reference guide for the Read API',
      link: 'https://openfga.dev/api-reference/relationship-tuples/get-tuples-from-the-store-that-matches-a-query-without-following-userset-rewrite-rules',
    },
    {
      title: 'Expand API Reference',
      description: 'Official reference guide for the Expand API',
      link: 'https://openfga.dev/api-reference/relationship-queries/expand-all-relationships-in-userset-tree-format-and-following-userset-rewrite-rules-useful-to-reason-about-and-debug-a-certain-relationship',
    },
    {
      title: 'ListObjects API Reference',
      description: 'Official reference guide for the ListObjects API',
      link: 'https://openfga.dev/api-reference/relationship-queries/list-all-objects-of-the-given-type-that-the-user-has-a-relation-with',
    },
    {
      title: 'ListUsers API Reference',
      description: 'Official reference guide for the ListUsers API',
      link: 'https://openfga.dev/api-reference/relationship-queries/list-the-users-matching-the-provided-filter-who-have-a-certain-relation-to-a-particular-type',
    },
  ]}
/>
