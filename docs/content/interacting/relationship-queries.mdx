...
:::caution Warning
ListObjects has sub-optimal performance if there are `and` or `but not` in your Authorization Model. Proceed with care if you intend to use this combination in production.
:::
