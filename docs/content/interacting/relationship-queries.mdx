...
1. [a particular user, relation, and object]()
2. [a particular user, relation, and object type]()
3. [a particular user and object with any relation]()
4. [a particular user and object type with any relation]()
5. [a particular relation and object for any user]()
6. [a particular object with any user and relation]()
7. [any user, relation, or object]()
...
#### 5. Read all tuples related to a particular object for any user
