---
title: How to setup SDK client
description: Setting up an OpenFGA SDK client
slug: /integration/setup-sdk-client
---
...
:::caution Warning
If you are going to use this setup in production, you should enable TLS in your OpenFGA server. Please see the [Production Checklist](../intro/setup-openfga.mdx#production-checklist).
:::
