...
A [store](../intro/openfga-concepts.mdx#what-is-a-store) is a OpenFGA entity that contains your authorization data. You will need to create a store in OpenFGA before adding an [authorization model](../intro/openfga-concepts.mdx#what-is-an-authorization-model) and [relationship tuples](../intro/openfga-concepts.mdx#what-is-a-relationship-tuple) to it.
