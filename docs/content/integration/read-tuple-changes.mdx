...
sidebar_position: 1
slug: /integration/read-tuple-changes
---
...
3. You have [configured the _authorization model_](../modeling) and [added some _relationship tuples_](./update-tuples.mdx#02-calling-write-api-to-add-new-relationship-tuples).
...
1. <SdkSetupPrerequisite />
2. You have [configured the _authorization model_](../modeling) and and [added some _relationship tuples_](./update-tuples.mdx#02-calling-write-api-to-add-new-relationship-tuples).
