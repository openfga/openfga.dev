---
title: CRM Authorization with OpenFGA
description: Model accounts, contacts, leads, opportunities, and territory-based access in OpenFGA for Salesforce-style and HubSpot-style CRM systems.
sidebar_position: 6
slug: /industries/crm
---
