...
Please share your configuration settings (you can omit any secrets). You can find more information on configuration in the [Configure OpenFGA documentation](./configure-openfga.mdx).
