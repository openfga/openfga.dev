...
Before configuring OpenFGA, follow [Getting Started](https://github.com/openfga/openfga?tab=readme-ov-file#getting-started) to set up and install openfga. You can then run `./openfga run` as a pre-compiled binary or using your preferred method.
