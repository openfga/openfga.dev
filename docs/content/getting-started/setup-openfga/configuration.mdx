...
The following table lists the configuration options for the OpenFGA server [v1.8.6](https://github.com/openfga/openfga/releases/tag/v1.8.6), based on the [config-schema.json](https://raw.githubusercontent.com/openfga/openfga/refs/tags/v1.8.6/.config-schema.json).
