...
- [Set Deployment Topology](#deployment-recommendations)
- [Set Database Options](#database-recommendations)
- [Set Concurrency Limits](#concurrency-limits)

## Deployment Recommendations

To ensure good performance, we recommend that:
- Your database and your OpenFGA servers are co-located in the same physical datacenter. This will minimize latency of database calls.
