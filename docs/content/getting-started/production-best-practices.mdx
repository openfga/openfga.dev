...
- [Configure Authentication](./setup-openfga/docker#configuring-authentication)
- Enable HTTP TLS or gRPC TLS or both
- Set the log.format to "json"
- Set the log.level to "info"
- [Disable the Playground](./setup-openfga/docker#playground).

## Database Recommendations

To ensure good performance for OpenFGA, it is recommended that the [database](./setup-openfga/docker#configuring-data-storage) be:
