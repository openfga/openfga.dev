...
This can be useful to help diagnose any suspected performance issues whehn using OpenFGA.
...
For example, a TypeScript application can be configured with tracing by using one of the [OpenTelemetry JavaScript Instrementation Libraries](https://opentelemetry.io/docs/languages/js/libraries/):
