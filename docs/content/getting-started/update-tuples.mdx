...
The Write API allows you to send up to <ConfigValue name="MAX_TUPLES_PER_WRITE" /> unique tuples in the request. (This limit applies to the sum of both writes and deletes in that request).
...
### 05. Ignoring duplicate/missing tuples
