...
| OPENFGA_CORS_ALLOWED_HEADERS              | If specified, the HTTP server will only allowed specific headers during preflight CORS option check.                                                                                                                                             | No       | array of string          | *             | `Origin,Accept,Content-Type,X-Requested-With`      |
