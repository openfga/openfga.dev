...
- Add a rate limiter interceptor [here](https://github.com/openfga/openfga/blob/400c6eb7af873f397522094d02771510ebd5a73e/server/server.go#L77) that protects your OpenFGA server against bursts in traffic.
- Add a logger interceptor [here](https://github.com/openfga/openfga/blob/400c6eb7af873f397522094d02771510ebd5a73e/server/server.go#L77) that sends logging to your logging platform of choice.
