...
:::note
Remember to expose the profiler port if you're running OpenFGA via docker. For example `docker run -p 8080:8080 -p 8081:8081 -p 3001:3001 openfga/openfga run`.
:::
