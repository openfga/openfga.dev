...
:::caution Warning
If you are going to use this setup in production, you should enable TLS in your OpenFGA server. Please see the [Production Checklist](./running-in-production).
:::
