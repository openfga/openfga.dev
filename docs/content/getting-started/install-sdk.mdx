...
To get started, install the <ProductName format={ProductNameFormat.ShortForm}/> SDK packages. These commands select the exact versions used by the API reference samples.
