...
3. You will ensure uniqueness. For example, different user may have the same user name. Using unique opaque identifiers removes the risk of adding incorrect relationships.

:::caution Note
This document uses first names and simple ids to illustrate easy-to-follow examples.
:::
