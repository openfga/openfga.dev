...
description: 'OpenFGA is an open-source fine-grained authorization (FGA) system. Build relationship-based, role-based, and attribute-based access control at scale.'
sidebar_position: 1
slug: /fga
---
...
<RelatedSection
  ...
  relatedLinks={[
    ...
    {
      title: 'Adopters',
      description: 'Production case studies from Agicap, Docker, Grafana Labs, Headspace, OpenLane, Read AI, Vitrolife, and Zuplo.',
      link: './customers',
      id: './customers',
    },
    {
    ...
    {
      title: 'Compare',
      description: 'OpenFGA versus SpiceDB, Cerbos, Permit.io, Oso, Ory Keto, OPA, and other engines.',
      link: './compare',
      id: './compare',
    }
  ]}
