...
<ProductName format={ProductNameFormat.ShortForm}/> helps developers achieving those benefits with features as:
...
- Github Actions for [testing](https://github.com/marketplace/actions/openfga-model-testing-action) and deploying [models](https://github.com/marketplace/actions/openfga-model-deploy-action)
