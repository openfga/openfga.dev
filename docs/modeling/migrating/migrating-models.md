...
- [Models are immutable](https://openfga.dev/docs/getting-started/immutable-models.md).
...
- [This document](https://openfga.dev/docs/modeling/migrating/migrating-relations.md) describes an end-to-end example for that use case.
