...
- A [Relation](https://openfga.dev/docs/concepts.md#what-is-a-relation): Defined in the type definition of an authorization model, a relation is a string that defines the possibility of a relationship between an object of the same type as the type definition and a user in the system.
...
- A [Contextual Tuple](https://openfga.dev/docs/concepts.md#what-are-contextual-tuples): a tuple that can be added to a Check request, and only exists within the context of that particular request.
