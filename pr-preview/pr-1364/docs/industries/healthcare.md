...
**Record inheritance.** Diagnoses and treatments use object-to-object relationships ([parent-child](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/modeling/parent-child.md)) so the care team inherits access through the encounter and patient. No separate ACL maintenance on every clinical note.
...
| Diagnosis/treatment inheritance         | [parent-child relationships](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/modeling/parent-child.md)                              |
| Multi-tenant org isolation              | tenant-scoped types, see [multi-tenant SaaS](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/use-cases/multi-tenant-saas.md)        |
| Time-bounded access (rotations, locums) | [contextual tuples](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/interacting/contextual-tuples.md)                               |
| Break-glass access logging              | tuple writes flow through the [Read Changes API](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/interacting/read-tuple-changes.md) |
...
For the operational side — encryption at rest, logging, deployment in a HIPAA boundary — see [Running OpenFGA in Production](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/best-practices/running-in-production.md).

## Working sample

The full schema, sample tuples, and assertion tests for the model above live in [openfga/sample-stores/stores/healthcare](https://github.com/openfga/sample-stores/tree/main/stores/healthcare). You can load it with the [FGA CLI](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/getting-started/cli.md) and run the included assertions to see the model behave end-to-end.
