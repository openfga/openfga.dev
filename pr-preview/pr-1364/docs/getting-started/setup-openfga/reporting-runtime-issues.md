...
canonical: "https://openfga.dev/pr-preview/pr-1364/docs/getting-started/setup-openfga/reporting-runtime-issues"
...
Please share your configuration settings (you should omit any secrets). You can find more information on configuration settings in the [Configure OpenFGA documentation](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/getting-started/setup-openfga/configure-openfga.md).
