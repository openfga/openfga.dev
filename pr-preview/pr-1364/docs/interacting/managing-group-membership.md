...
Assume that you have the following [authorization model](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/concepts.md#what-is-an-authorization-model).<br />You have two [types](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/concepts.md#what-is-a-type):* `org` that can have a `member` relation
...
With the above authorization model and relationship tuples, OpenFGA will respond with `{"allowed":false}` when _[check](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/concepts.md#what-is-a-check-request)_ is called to see if Anne can read `document:planning`.
...
You need to know how to add users to groups and grant groups access to an object. [Learn more →](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/modeling/user-groups.md)

### Managing group access

You need to know how to manage group access to an object. [Learn more →](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/interacting/managing-group-access.md)
