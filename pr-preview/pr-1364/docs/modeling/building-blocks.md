...
- [Direct Relationships](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/modeling/building-blocks/direct-relationships.md)

**Concentric Relationships**

Learn to model nested relationships in your application.

- [Concentric Relationships](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/modeling/building-blocks/concentric-relationships.md)

**Object to Object Relationships**

Learn to model your application with objects that are not specifically tied to a user.

- [Object to Object Relationships](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/modeling/building-blocks/object-to-object-relationships.md)

**Usersets**

Learn to model your application by assigning relationships to groups of users.

- [Usersets](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/modeling/building-blocks/usersets.md)
