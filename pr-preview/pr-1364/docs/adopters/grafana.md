...
canonical: "https://openfga.dev/pr-preview/pr-1364/docs/adopters/grafana"
...
The team standardized on the **PostgreSQL adapter** after finding the MySQL adapter less mature. Refactoring Grafana's legacy schema toward OpenFGA-native modeling produced significant performance gains — an outcome echoed by the [source-of-truth best practice](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/best-practices.md).
