...
canonical: "https://openfga.dev/pr-preview/pr-1364/docs/adopters/agicap"
...
- Performance work over time pushed Agicap from a deeper hierarchy to a flatter authorization model, which improved both query latency and scalability — a pattern documented in the [performance best practices](https://openfga.dev/pr-preview/pr-1364/pr-preview/pr-1364/docs/best-practices.md).
