...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/use-cases/microservices-authorization"
...
- **One model to reason about.** Cross-service questions (_"can this user read this document via their team's project access?"_) become a single graph traversal instead of a coordination dance.
...
- [Running OpenFGA in production](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/best-practices/running-in-production.md)
- [Source of truth](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/best-practices/source-of-truth.md)
- [Multi-tenant SaaS](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/use-cases/multi-tenant-saas.md)
