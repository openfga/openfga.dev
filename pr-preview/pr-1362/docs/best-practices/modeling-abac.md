...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/best-practices/modeling-abac"
...
The simplest approach for boolean attributes is using the [Public Access](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/public-access.md) pattern. By assigning `user:*` to a relation, you effectively create a boolean flag that applies to all users.
...
For time-based, IP-based conditions and more, see the [Conditions documentation](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/conditions.md) for detailed examples.
