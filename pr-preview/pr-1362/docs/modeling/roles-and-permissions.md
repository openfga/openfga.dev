...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/modeling/roles-and-permissions"
...
Roles and permissions can be modeled within [OpenFGA](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/fga.md) using an [authorization model](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-an-authorization-model) and [relationship tuples](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-relationship-tuple).

- **Roles** are assigned to [users](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-user) or a group of users. Any user can have more than one role, like `editor` or `owner`.
- **Permissions** allow users to access certain [objects](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-an-object) based on their specific roles, like `device_renamer` or `channel_archiver`.
...
Familiarize yourself with the basics of [OpenFGA Concepts](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md).

Assume that you have the following [authorization model](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-an-authorization-model) and a [type](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-type) called `trip` that users can be related to as `viewer` and/or an `owner`.
...
Creating an authorization model and a relationship tuple can grant a user access to an object. To learn more, [read about Direct Access](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/direct-access.md)
...
- A [Relation](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-relation): a string defined in the type definition of an authorization model that defines the possibility of a relationship between an object of the same type as the type definition and a user in the system
...
- A [Relationship Tuple](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-relationship-tuple): a group stored in OpenFGA that consists of a user, a relation, and an object
- A [Relationship](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-relationship): OpenFGA will be called to check if there is a relationship between a user and an object, indicating that the access is allowed
- [Union Operator](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/configuration-language.md#the-union-operator): can be used to indicate that the user has multiple ways of being related to an object
- [Direct Relationship Type Restrictions](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/configuration-language.md#direct-relationship-type-restrictions): can be used to indicate direct relationships between users and objects
- A [Check API Request](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-check-request): used to check for relationships between users and objects
...
To represent this in an [OpenFGA](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/fga.md) environment, you need to:
...
3. [Check](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-check-request) user roles and their permissions based on relationship tuples for direct and implied relations
...
Permissions are relations that users get through other relations. To avoid adding a [direct relationship type restriction](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/configuration-language.md#direct-relationship-type-restrictions) to the relation in the authorization model while representing permissions, they instead define the relation via other relations in the model, which indicates that it is a permission granted to and implied from a different relation.
...
> Note: both `booking_viewer` and `booking_adder` don't have [direct relationship type restrictions](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/configuration-language.md#direct-relationship-type-restrictions), which ensures that the relation can only be assigned through the role and not directly.

### 03. Check user roles and their permissions

Your type definitions reflects the roles and permissions on how bookings can be viewed/added, so you can create [relationship tuples](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-relationship-tuple) to assign roles to users, then [check](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-check-request) if users have the proper permissions.
...
- [More](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/building-blocks/concentric-relationships.md)

**Modeling Google Drive**

See how to indicate that editors are commenters and viewers in Google Drive.

- [More](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/advanced/gdrive.md#01-individual-permissions)

**Modeling GitHub**

See how to indicate that repository admins are writers and readers in GitHub.

- [More](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/advanced/github.md#01-permissions-for-individuals-in-an-org)
