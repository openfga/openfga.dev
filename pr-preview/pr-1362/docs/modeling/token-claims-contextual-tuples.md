...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/modeling/token-claims-contextual-tuples"
...
To enable more ABAC use-cases that rely on specific attributes and conditions, you can also use OpenFGA\`s [conditions](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/conditions.md).

## Before You Start

To follow this guide, familiarize yourself with the following [OpenFGA Concepts](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md):
...
- Are only supported on the [Check API endpoint](https://openfga.dev/api-reference/relationship-queries/check-whether-a-user-is-authorized-to-access-an-object), [ListObjects API endpoint](https://openfga.dev/api-reference/relationship-queries/list-all-objects-of-the-given-type-that-the-user-has-a-relation-with) and [ListUsers API endpoint](https://openfga.dev/api-reference/relationship-queries/list-the-users-matching-the-provided-filter-who-have-a-certain-relation-to-a-particular-type). They are not supported on read, expand, or other endpoints.

- If you use the [Read Changes API endpoint](https://openfga.dev/api-reference/relationship-tuples/return-a-list-of-all-the-tuple-changes) to build a permission aware search index, it may be difficult to account for contextual tuples.
...
- [More](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/organization-context-authorization.md)
