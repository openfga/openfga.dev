...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/modeling/public-access"
...
In this guide you will learn how to grant public access to an [object](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-an-object), such as a certain document, using [type bound public access](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-type-bound-public-access).
...
Assume that you have the following [authorization model](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-an-authorization-model).<br />You have a [type](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-type) called `document` that can have a `view` relation.
...
- A [Type Bound Public Access](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-type-bound-public-access): is a special OpenFGA concept (represented by `<type>:*`) can be used in relationship tuples to represent every object of that type
...
To do this we need to create a relationship tuple using the [type bound public access](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-type-bound-public-access). The type bound public access syntax is used to indicate that all users of a particular type have a relation to a specific object.
