---
title: "Store File Format"
description: "Store File Format (.fga.yaml)"
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/modeling/store-file-format"
...
3. **Comprehensive testing**: Include check, list\_objects, and list\_users tests to validate all API behaviors
...
Learn more about testing models

**Testing Models**

Learn how to test your authorization models
