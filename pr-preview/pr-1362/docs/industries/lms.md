...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/industries/lms"
...
Learning management systems — Canvas, Moodle, Blackboard, plus internal corporate training platforms — combine curriculum hierarchy with per-user enrollment. A student enrolled in _one_ class section sees _that_ class's materials but not the rest of the course catalog; an instructor authoring a quiz can edit it even when their general role is "instructor, not owner".
...
**Enrollment is per-class, not per-course.** A student enrolled in section A of _Intro to Biology_ doesn't automatically see section B. Modeling the class as its own object with its own enrollment list keeps cross-section data isolated, which matters for grades and discussion threads.
...
| Course → class hierarchy       | [parent-child relationships](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/parent-child.md)                       |
...
| Multi-tenant LMS SaaS          | tenant-scoped types, see [multi-tenant SaaS](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/use-cases/multi-tenant-saas.md) |
...
- **Time-bounded enrollment.** Use [conditions](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/conditions.md) to expire student access at the end of a term without rewriting tuples.
...
Schema, sample tuples, and assertions are in [openfga/sample-stores/stores/lms](https://github.com/openfga/sample-stores/tree/main/stores/lms). For the broader pattern of "role at the org, scoped relationships per record", see [Modeling Roles](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/best-practices/modeling-roles.md).
