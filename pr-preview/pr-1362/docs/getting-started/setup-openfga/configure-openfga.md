...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/getting-started/setup-openfga/configure-openfga"
...
For a list of all the configuration options that the latest release of OpenFGA supports, see [Configuration Options](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/configuration.md), or you can run `openfga --help` to see the ones specific to your version.
...
To learn how to run in Docker, check our [Docker documentation](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/docker.md#using-postgres).
...
To learn how to run in Docker, check our [Docker documentation](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/docker.md#using-mysql).
...
To learn how to run in Docker, check our [Docker documentation](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/docker.md#using-sqlite).
...
To learn how to run in Docker, check our [Docker documentation](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/docker.md#pre-shared-key-authentication).
...
To learn how to run in Docker, check our [Docker documentation](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/docker.md#oidc-authentication).
...
Various releases of OpenFGA may have experimental features that can be enabled by providing the [`--experimentals`](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/configuration.md#OPENFGA_EXPERIMENTALS) flag or the `experimentals` config.
...
| enable-access-control      | Enables the ability to configure and setup [access control](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/access-control.md) | `1.7.0 <= v`         |
...
- [More](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/configuration.md)

**Running OpenFGA in Production**

Learn the best practices of running OpenFGA in a production environment

- [More](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/best-practices/running-in-production.md)
