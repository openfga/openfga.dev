...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/getting-started/cli"
...
The OpenFGA Command Line Interface (CLI) enables you to interact with an FGA store, where you can manage tasks, create stores, and update FGA models, among other actions. For more information on FGA stores, see [What Is A Store](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-store).
...
If you use [pre-shared key authentication](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/configure-openfga.md#pre-shared-key-authentication), provide the following parameters which appends the pre-shared key in the HTTP request header:

| Name      | Flag        | Environment     | \~/.fga.yaml |
| --------- | ----------- | --------------- | ------------ |
| API Token | --api-token | FGA\_API\_TOKEN | api-token    |

If you use [OIDC authentication](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/setup-openfga/configure-openfga.md#oidc), configure the following parameters based on the OIDC server that’s used to issue tokens:
...
OpenFGA models are [immutable](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/immutable-models.md); each time a model is written to a store, a new version of the model is created.
...
The CLI can import an [FGA Test file](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/testing.md) in a store. It writes the model included and imports the tuples in the fga test file.
...
- [More](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/testing.md)
