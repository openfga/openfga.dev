...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/getting-started/create-store"
...
A [store](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-store) is a OpenFGA entity that contains your authorization data. You will need to create a store in OpenFGA before adding an [authorization model](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-an-authorization-model) and [relationship tuples](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/concepts.md#what-is-a-relationship-tuple) to it.
