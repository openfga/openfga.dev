...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/getting-started/framework"
...
2. You have [installed the OpenFGA SDK](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/install-sdk.md).
...
4. You know how to [perform a Check](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/perform-check.md).
...
Next, we will create a decorator called `authorize`. This decorator will invoke the [Check API](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/perform-check.md) to see if the user has a relationship with the specified document.
...
- `checkAuthorization` will call the [`Check API`](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/getting-started/perform-check.md) to see if the user has a relationship with the specified document.
...
- [More](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/modeling/advanced/slack.md)
