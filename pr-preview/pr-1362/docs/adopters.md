...
canonical: "https://openfga.dev/pr-preview/pr-1362/docs/adopters"
...
| ------------------------------------------------------------------------------------------------------- | ------------------------ | ------------------- | ------------------------------------------------ |
| [Read AI](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/adopters/read-ai.md)           | AI meeting intelligence  | April 2023          | 5,200 RPS peak, 5.3B+ tuples                     |
| [Agicap](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/adopters/agicap.md)             | Fintech                  | April 2023          | \~250 RPS, 8,000+ customers                      |
| [Zuplo](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/adopters/zuplo.md)               | API management           | 2024                | 500+ RPS spikes, multi-region edge               |
| [Grafana Labs](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/adopters/grafana.md)      | Observability            | 2024                | Multi-tenant SaaS + embedded OSS                 |
| [Docker](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/adopters/docker.md)             | Developer tools          | March 2024          | 100-150 RPS                                      |
| [Headspace](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/adopters/headspace.md)       | Mental health & consumer | 2024                | 90M lives, 6M Ebb messages, 10-15 ms p99         |
| [OpenLane](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/adopters/openlane.md)         | Compliance SaaS          | 2024                | ent ORM hooks, BatchCheck overfetch (100/1000)   |
| [Vitrolife Group](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/adopters/vitrolife.md) | Healthcare               | 2025                | Hybrid Entra + OpenFGA, hourly differential sync |
...
- **ReBAC over RBAC.** Each team chose relationship-based access control for the flexibility it gives over flat role models. See [authorization concepts](https://openfga.dev/pr-preview/pr-1362/pr-preview/pr-1362/docs/authorization-concepts.md) for a refresher.
