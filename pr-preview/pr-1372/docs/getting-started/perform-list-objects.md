...
canonical: "https://openfga.dev/pr-preview/pr-1372/docs/getting-started/perform-list-objects"
...
This section describes how to perform a [list objects](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-list-objects-request) request. The List Objects API allows you to retrieve all [objects](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object) of a specified [type](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-type) that a [user](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-user) has a given [relationship](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relationship) with. This can be used in scenarios like displaying all documents a user can read or listing resources a user can manage.
...
- [More](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/api/service#Relationship%20Queries/StreamedListObjects)
