...
canonical: "https://openfga.dev/pr-preview/pr-1372/docs/getting-started/setup-openfga/docker"
...
This article explains how to run your own OpenFGA server using Docker. To learn the different ways to configure OpenFGA check [Configuring OpenFGA](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/getting-started/setup-openfga/configure-openfga.md).
