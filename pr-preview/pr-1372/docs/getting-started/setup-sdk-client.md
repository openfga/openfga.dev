...
canonical: "https://openfga.dev/pr-preview/pr-1372/docs/getting-started/setup-sdk-client"
...
The first step is to ensure that you have created a store by following [these steps](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/getting-started/create-store.md).
...
If you are going to use this setup in production, you should enable TLS in your OpenFGA server. Please see the [Running OpenFGA in Production](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/best-practices/running-in-production.md).
