...
canonical: "https://openfga.dev/pr-preview/pr-1372/docs/adopters/agicap"
...
- Performance work over time pushed Agicap from a deeper hierarchy to a flatter authorization model, which improved both query latency and scalability — a pattern documented in the [performance best practices](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/best-practices.md).
