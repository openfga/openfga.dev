...
canonical: "https://openfga.dev/pr-preview/pr-1372/docs/configuration-language"
...
OpenFGA's Configuration Language builds a representation of a system's [authorization model](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-authorization-model), which informs [OpenFGA's API](https://openfga.dev/pr-preview/pr-1372/api/service) on the [object types](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-type) in the system and how they relate to each other. The Configuration Language describes the [relations](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relation) possible for an object of a given type and lists the conditions under which one is related to that object.

The Configuration Language can be presented in **DSL** or **JSON** syntax. The JSON syntax is accepted by the API and closely tracks the language in the [Zanzibar paper](https://research.google/pubs/pub48190/). The DSL adds syntactic sugar on top of JSON for ease of use, but compiles down to JSON before being sent to OpenFGA's API. JSON syntax is used to call API directly or through the [SDKs](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/getting-started.md), while DSL is used to interact with OpenFGA in the [Playground](https://play.fga.dev/), the [CLI](https://github.com/openfga/cli), and the IDE extensions for [Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=openfga.openfga-vscode) and [IntelliJ](https://plugins.jetbrains.com/plugin/24394-openfga). They can be switched between throughout this documentation.

Please familiarize yourself with basic [OpenFGA Concepts](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md) and [How to get started on modeling](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/getting-started.md) before starting this guide.
...
The authorization model describes four [types](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-type) of objects: `user`, `domain`, `folder` and `document`.

The `domain` [type definition](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-type-definition) has a single [relation](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relation) called `member` that only allows [direct relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-are-direct-and-implied-relationships).
...
When used at the beginning of a [relation definition](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relation-definition), `[<string>, <string>, ...]` allows [direct relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-are-direct-and-implied-relationships) by the objects of these specified types, for example, `[user, user:*, team#member]`. The strings can be in one of three formats:
...
The `team` [type definition](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-type-definition) above defines all the [relations](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relation) that [users](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-user) can have with an _[object](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object)_ of type `team`. In this example, the relation is `member`.

Because of the `[user, team#member]` direct relationship type restrictions used, a user in the system can have a **[direct relationship](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-are-direct-and-implied-relationships)** with the `team` type as a `member` for objects of:

- type `user`
- the `user` [type bound public access](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-type-bound-public-access) (`user:*`)
- [usersets](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/usersets.md) that have a `team` type and a `member` relation (e.g. `team:product#member`)
...
For more examples, see [Modeling Building Blocks: Direct Relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/direct-relationships.md).
...
Above, `document` [type definition](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-type-definition) defines all the [relations](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relation) that [users](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-user) can have with an [object](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object) of type `document`. In this case, the relations are `editor`, `viewer` and `can_rename`. The `viewer` and `can_rename` relation definitions both reference `editor`, which is another relation of the same type.
...
For more examples, see [Modeling Building Blocks: Concentric Relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/concentric-relationships.md), [Modeling: Roles and Permissions](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/roles-and-permissions.md) and [Advanced Modeling: Google Drive](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/advanced/gdrive.md).

### Referencing Relations On Related Objects

Another set of [indirect relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-are-direct-and-implied-relationships) are made possible by referencing relations to other objects.
...
For more examples, see [Modeling: Parent-Child Objects](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/parent-child.md), [Advanced Modeling: Google Drive](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/advanced/gdrive.md), [Advanced Modeling: GitHub](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/advanced/github.md), and [Advanced Modeling: Entitlements](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/advanced/entitlements.md).

### The Union Operator

The **union operator** (`or` in the DSL, `union` in the JSON syntax) indicates that a [relationship](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relationship) exists if the [user](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-user) is in any of the sets of users (`union`).
...
In the [type definition](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-type-definition) snippet above, `user:anne` is a `viewer` of `document:new-roadmap` if any of the following conditions are satisfied:

- there exists a [direct relationship](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-are-direct-and-implied-relationships) with _anne_ as _editor_ of _document:new-roadmap_
  ```
  [{
...
The above [authorization model](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-authorization-model) indicates that a user is related as a viewer if they are in any of the following:
...
If `anne` is in at least one of those usersets, meaning `anne` is either an `editor` or a `viewer`, the [check](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-check-request) on `{"user": "user:anne", "relation": "viewer", "object": "document:new-roadmap"}` returns `{"allowed": true}`.

For more examples, see [Modeling Building Blocks: Concentric Relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/concentric-relationships.md), [Modeling Roles and Permissions](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/roles-and-permissions.md) and [Advanced Modeling: Modeling for IoT](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/advanced/iot.md#03-updating-our-authorization-model-to-facilitate-future-changes).

### The Intersection Operator

The **intersection operator** (`and` in the DSL, `intersection` in the JSON syntax) indicates that a [relationship](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relationship) exists if the [user](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-user) is in all the sets of users.
...
In the [type definition](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-type-definition) snippet above, `user:anne` is a `viewer` of `document:new-roadmap` if all of the following conditions are satisfied:
...
The above [authorization model](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-authorization-model) indicates that a user is related as a viewer if they are in all of the following:
...
`anne` must be in the intersection of the usersets (meaning both an `editor` AND an `authorized_user`) for the [check](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-check-request) on `{"user": "user:anne", "relation": "viewer", "object": "document:new-roadmap"}` to return `{"allowed": true}`.
...
For more examples, see [Modeling with Multiple Restrictions](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/multiple-restrictions.md).

### The Exclusion Operator

The **exclusion operator** (`but not` in the DSL, `difference` in the JSON syntax) indicates that a [relationship](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relationship) exists if the [user](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-user) is in the base userset but not in the excluded userset. This operator is particularly useful when modeling exclusion or block lists.
...
For more information, see [Modeling: Blocklists](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/blocklists.md).

info

The [authorization model](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-authorization-model) above indicates that a user is related as a viewer if they are in:
...
`anne` must be both a `viewer` and not `blocked` for the [check](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-check-request) on `{"user": "user:anne", "relation": "viewer", "object": "document:new-roadmap"}` to return `{"allowed": true}`.
...
OpenFGA supports conditional relationships, which are only considered if a specific condition is met. You can learn more about Conditional Relationships in the [Modeling: Conditional Relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/conditions.md) guide.
...
- The users with a viewer relationship to a certain doc are any of:
  ...
  - the set of users who are [directly related](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-are-direct-and-implied-relationships) with this doc as `viewer`
...
- [More](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/getting-started.md)
