...
canonical: "https://openfga.dev/pr-preview/pr-1372/docs/industries/lms"
...
| Course → class hierarchy       | [parent-child relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/parent-child.md)                       |
...
| Multi-tenant LMS SaaS          | tenant-scoped types, see [multi-tenant SaaS](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/use-cases/multi-tenant-saas.md) |
...
- **Time-bounded enrollment.** Use [conditions](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/conditions.md) to expire student access at the end of a term without rewriting tuples.
