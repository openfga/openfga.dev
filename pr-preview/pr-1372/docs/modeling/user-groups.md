...
canonical: "https://openfga.dev/pr-preview/pr-1372/docs/modeling/user-groups"
...
To add users to groups and grant groups access to an [object](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object) using [OpenFGA](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/fga.md).
...
Familiarize yourself with the [OpenFGA Concepts](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md).

Assume you have the following [authorization model](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-authorization-model).<br />: you have an _[object](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object)_ called `document` that users can relate to as an `editor`.
...
You need to know how to create an authorization model and a relationship tuple to grant a user access to an object. To learn more, see [direct access](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/direct-access.md).
...
- An [Object](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object): represents an entity in the system. Users' relationships to it can be defined with relationship tuples and the authorization model.
...
First, define the _[object](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object)_ `team` in your authorization model. In this use case, a `team` can have `member`s, so you make the following changes to the authorization model:
...
You can now assign _[users](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-user)_ as `member`s of `team`s. Create a new _[relationship tuple](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relationship-tuple)_ that states `user:alice` is a member of `team:writers`.
...
The \*[check](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-check-request)\ `is alice an editor of document:meeting_notes.doc` returns the following:
...
- [More](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/interacting/managing-group-membership.md)

**Modeling Google Drive**

See how User Groups can be used to share documents within a domain in the Google Drive use-case.

- [More](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/advanced/gdrive.md#02-organization-permissions)

**Modeling GitHub**

Granting teams permissions to a repo in the GitHub use-case.

- [More](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/advanced/github.md#02-permissions-for-teams-in-an-org)
