...
canonical: "https://openfga.dev/pr-preview/pr-1372/docs/modeling/building-blocks/usersets"
...
A userset represents a set or collection of [users](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-user).

Usersets can be used to indicate that a group of users in the system have a certain [relation](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relation) with an [object](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object). This can be used to assign permissions to groups of users rather than specific ones, allowing us to represent the permissions in our system using less tuples and granting us flexibility in granting or denying access in bulk.

In OpenFGA, usersets are represented via this notation: `object#relation`, where [object](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object) is made up of a [type](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-type) and an object identifier. For example:
...
If we wanted to see which users and usersets have a `reader` relationship with `document:budget`, we can call the [Expand API](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/api/service#Relationship%20Queries/Expand). The response will contain a userset tree where the leaf nodes are specific user IDs and usersets. For example:
...
As you can see from the response above, with usersets we can express [unions](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/configuration-language.md#the-union-operator) of user groups. We can also express [intersections](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/configuration-language.md#the-intersection-operator) and [exclusions](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/configuration-language.md#the-exclusion-operator).

## Internals

Using the type definitions in the authorization model, some of the situations we can represent are:

- that a user is **not** in a set of users having a certain relation to an object, even if a relationship tuple exists in the system. See [Disabling Direct Relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/direct-relationships.md#2-with-direct-relationships-disabled)
- that a user has a certain relationship with an object if they are in the [union](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/configuration-language.md#the-union-operator), [intersection](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/configuration-language.md#the-intersection-operator) or [exclusion](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/configuration-language.md#the-exclusion-operator) of usersets.
- that a user being in a set of users having a certain relation to an object can result in them having another relation to the object. See [Concentric Relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/concentric-relationships.md)
- that the user being in a set of users having a certain relation to an object and that object is in a set of users having a certain relation to another object, can imply that the original user has a certain relationship to the final object. See [Object-to-Object Relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/object-to-object-relationships.md)
...
![Image showing the path  traverses to find if a user is in the userset related to an object](/pr-preview/pr-1372/assets/images/usersets-check-tree-68f05e3f382b35ea6be97c5115223351.png)
...
- [More](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/interacting/managing-group-access.md)
