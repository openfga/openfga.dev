...
canonical: "https://openfga.dev/pr-preview/pr-1372/docs/modeling/advanced/gdrive"
...
This tutorial explains how to represent [Google Drive](https://www.google.com/intl/en-GB/drive/) permissions model with [OpenFGA](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/fga.md).

**What you will learn**

- Indicate [relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relationship) between a group of **[users](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-user)** and an **[object](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object)**. See [Modeling User Groups](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/user-groups.md) for more.
  <br />
  Used here to indicate that all users within a domain can access a document (sharing a document within an organization).
- Model **concentric relationship** to have a certain [relation](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relation) on an object imply another relation on the same object. See [Modeling Concepts: Concentric Relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/concentric-relationships.md) for more.
  <br />
  Used here is to indicate that writers are also commenters and viewers.
- Using [**the union operator**](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/configuration-language.md#the-union-operator) condition to indicate that a user might have a certain relation with an object if they match any of the criteria indicated.
  <br />
...
- Using the **[type bound public access](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-type-bound-public-access)** in a [relationship tuple's](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relationship-tuple) user field to indicate that everyone has a certain relation with an object. See [Modeling Public Access](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/public-access.md) for more.
  <br />
  Used here to [share documents publicly](#04-sharing-files-and-folders-publicly).
- Model [**parent-child objects**](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/parent-child.md) to indicate that a user having a relationship with a certain object implies having a relationship with another object in OpenFGA.
  <br />
...
You need to know how to create relationships between objects and how that might affect a user's relationships to those objects. [Learn more →](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/object-to-object-relationships.md)
...
You need to know how to add a relationship tuple to indicate that a resource is publicly available. [Learn more →](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/public-access.md)

#### Concepts & configuration language

- The [OpenFGA Concepts](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md)
...
![Image showing permissions](/pr-preview/pr-1372/assets/images/gdrive-gdrive1-22dac26c1f55a55daeb65acff88ee193.svg)

To represent permissions in OpenFGA we use [relations](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relation). For document permissions we need to create the following [authorization model](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-authorization-model):
...
This means that a user can be [directly related](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-are-direct-and-implied-relationships) as a viewer to an object of type "document"
...
And [ask](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-check-request) some questions to OpenFGA:
...
![Image showing roles](/pr-preview/pr-1372/assets/images/gdrive-roles-ac60dede6567bd76e873d1a81d642532.svg)
...
![](/pr-preview/pr-1372/assets/images/gdrive-org-fe69008225e62f28ff2280708e875f09.svg)

At the end of this section we want to end up with the following permissions represented:

![Image showing permissions](/pr-preview/pr-1372/assets/images/gdrive-gdrive2-abe697d20cfce6658d6a09aed7af8d97.svg)

To add support for domains and members all we need to do is add this object to the [OpenFGA](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/fga.md) [authorization model](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-type-definition). In addition, update the model to allow domain member to be assigned to document:
...
The last relationship tuple introduces a new **OpenFGA** concept. A **[userset](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-user)**. When the value of a user is formatted like this **objectType:objectId#relation**, OpenFGA will automatically expand the userset into all its individual user identifiers:
...
![Image showing permissions](/pr-preview/pr-1372/assets/images/gdrive-gdrive3-e82c9d5308de7d3b5e7b74b59d87044f.svg)
...
More details on this technique can be found in the section [Modeling Parent-Child Objects](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/parent-child.md).
...
- the "viewers": the set of users who are [directly related](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-are-direct-and-implied-relationships) to the document as a "viewer"
...
![Image showing requirements](/pr-preview/pr-1372/assets/images/gdrive-gdrive4-9b75eafa345dde22742988b225671a69.svg)

Here's where another OpenFGA feature, [type bound public access](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-type-bound-public-access) (as in everyone), would come in handy.
...
- [More](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/interacting/search-with-permissions.md)
