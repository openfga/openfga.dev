...
canonical: "https://openfga.dev/pr-preview/pr-1372/docs/modeling/parent-child"
...
In OpenFGA, a user's [relationship](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-a-relationship) with an [object](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-object) can affect their relationship with another object. For example, an `editor` of a `folder` can also be an `editor` of all `documents` that `folder` is a `parent` of.

**When to use**

Object-to-object relationships can combine with a configured authorization model to indicate that a user's relationship with one object may influence the user's relationship with another object. They can also eliminate the need to modify relationships between objects using [user groups](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/user-groups.md#03-assign-the-team-members-a-relation-to-an-object).
...
Familiarize yourself with basic [OpenFGA Concepts](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md):

Assume that you have the following [authorization model](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/concepts.md#what-is-an-authorization-model).<br />You have two types:* `folder` that users can be related to as an `editor`
...
As documented in [Modeling Concepts: Object to Object Relationships](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/object-to-object-relationships.md), the following update to the authorization model allows a `parent` relation between a `folder` and a `document`:
...
For more information on this topic, see [Referencing Relations on Related Objects](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/configuration-language.md#referencing-relations-on-related-objects).
...
- [More](https://openfga.dev/pr-preview/pr-1372/pr-preview/pr-1372/docs/modeling/building-blocks/object-to-object-relationships.md)
