...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/getting-started/perform-list-objects"
...
This section describes how to perform a [list objects](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-list-objects-request) request. The List Objects API allows you to retrieve all [objects](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-an-object) of a specified [type](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-type) that a [user](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-user) has a given [relationship](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relationship) with. This can be used in scenarios like displaying all documents a user can read or listing resources a user can manage.
...
Conditions and List Objects

When a relation uses a [condition](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/conditions.md) with a per-object attribute that is NOT stored in the tuple context, the List Objects API may not return correct results. The API accepts a single `context` per call, but each candidate object may have a different value for that attribute. If the per-object attribute is stored in the tuple context (written alongside the relationship tuple), ListObjects works correctly because the value is resolved per tuple. See [Conditions: Limitations](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/conditions.md#conditions-and-enumeration-queries-listobjects--listusers) for details.
...
- [More](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/api/service#Relationship%20Queries/StreamedListObjects)
