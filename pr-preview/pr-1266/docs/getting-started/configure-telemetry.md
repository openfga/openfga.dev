...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/getting-started/configure-telemetry"
...
1. [Install the OpenFGA SDK Client](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/install-sdk.md)
...
OpenFGA [supports](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/setup-openfga/configure-openfga.md) tracing with OpenTelemetry.
