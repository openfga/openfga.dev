...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/use-cases/multi-tenant-saas"
...
The full working example — including tuples, group nesting (`group:acme-data-engineering#member` ∈ `group:engineering#member`), and `list_users` assertions — is in the [multitenant-rbac sample store](https://github.com/openfga/sample-stores/tree/main/stores/multitenant-rbac). You can run it locally with the [FGA CLI](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/cli.md) to see the checks pass.

## Modeling building blocks

- [Modeling parent-child](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/parent-child.md)
- [Modeling roles](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/best-practices/modeling-roles.md)
- [Source of truth](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/best-practices/source-of-truth.md)

## Related reading

- [Microservices authorization](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/use-cases/microservices-authorization.md)
