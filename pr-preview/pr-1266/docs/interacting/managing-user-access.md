...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/interacting/managing-user-access"
...
In this guide you will learn how to grant a [user](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-user) access to a particular [object](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-an-object).

**When to use**

Granting access with a _[relationship tuple](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relationship-tuple)_ is a core part of OpenFGA. Without any relationship tuples, any _[check](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-check-request)_ will fail. You should use:
...
Assume that you have the following [authorization model](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-an-authorization-model).<br />You have a [type](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-type) called `tweet` that can have a `reader`.
...
With the above, we have added a [**direct** relationship](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/building-blocks/direct-relationships.md) between Anne and `tweet:1`. When we call the Check API to see if Anne has a `reader` relationship, OpenFGA will say yes.
...
With this, we have removed the [direct relationship](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/building-blocks/direct-relationships.md) between Anne and `tweet:1`. And because our type definition for `reader` does not include any other relations, a call to the Check API will now return a negative response.
...
- [More](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/update-tuples.md)
