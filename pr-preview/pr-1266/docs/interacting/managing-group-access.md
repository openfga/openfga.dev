...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/interacting/managing-group-access"
...
Familiarize yourself with basic [OpenFGA Concepts](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md) before you continue.

In the example below, you have the following [authorization model](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-an-authorization-model) with two [types](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-type):* `company` that can have an `employee` relation
...
OpenFGA allows you to add users to groups and grant groups access to an object. [For more information, see User Groups.](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/user-groups.md)
...
The following [Relationship Tuple](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relationship-tuple) assigns ever `employee` of a type `company` a `reader` relationship with a particular object of type `document`, in this case `document:planning`):
...
Below is a [relationship tuple](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relationship-tuple) specifying that `Anne` is an `employee` of `company:xyz`:
