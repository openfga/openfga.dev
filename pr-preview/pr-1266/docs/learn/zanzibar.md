...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/learn/zanzibar"
...
- **Schema** — written in the [OpenFGA DSL](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/configuration-language.md).
- **Tuples** — stored in PostgreSQL, MySQL, or SQLite.
- **Check** and **Expand** — exposed via the [API](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/interacting/relationship-queries.md).
...
- [More](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/learn/fine-grained-authorization.md)
