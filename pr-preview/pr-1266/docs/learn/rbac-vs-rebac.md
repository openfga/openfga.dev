...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/learn/rbac-vs-rebac"
...
OpenFGA is a [ReBAC](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/learn/rebac.md) engine that **also models RBAC cleanly**: a role is a relation on a tenant, and the model lets the same user be a different role in different tenants without any duplication. The [Modeling Roles](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/best-practices/modeling-roles.md) guide walks through the pattern.
...
- [More](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/learn/abac-vs-rebac.md)

**Modeling roles**

Patterns for representing roles in OpenFGA.

- [More](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/best-practices/modeling-roles.md)
