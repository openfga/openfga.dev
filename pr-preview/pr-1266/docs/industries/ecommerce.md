...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/industries/ecommerce"
...
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Multi-store organizations           | [parent-child relationships](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/parent-child.md)  |
...
| Tenant isolation per merchant       | see [multi-tenant SaaS](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/use-cases/multi-tenant-saas.md) |
