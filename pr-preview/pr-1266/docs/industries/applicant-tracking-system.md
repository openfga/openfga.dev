...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/industries/applicant-tracking-system"
...
| Multi-tenant ATS SaaS                      | tenant-scoped types, see [multi-tenant SaaS](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/use-cases/multi-tenant-saas.md) |
...
- **EEO / sensitive demographic fields.** Gate via [conditions](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/conditions.md) or a separate `can_view_eeo` relation restricted to compliance staff, distinct from the general candidate viewer set.
- **Time-bound interviewer access.** Use [conditions](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/conditions.md) so an interviewer's access to a candidate expires after the debrief, instead of relying on a cleanup job.
