...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/industries/lms"
...
| Course → class hierarchy       | [parent-child relationships](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/parent-child.md)                       |
...
| Multi-tenant LMS SaaS          | tenant-scoped types, see [multi-tenant SaaS](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/use-cases/multi-tenant-saas.md) |
...
- **Time-bounded enrollment.** Use [conditions](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/conditions.md) to expire student access at the end of a term without rewriting tuples.
