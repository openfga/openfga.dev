...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/adopters/headspace"
...
- **Wrapper API in front of OpenFGA.** Application services do not call the OpenFGA store directly. They call an internal authorization service that fans out **four parallel [BatchCheck](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/interacting/relationship-queries.md) requests** — assigned-to-Ebb, country-allowed, language-allowed, and not-blocked-by-org — and combines the results.
