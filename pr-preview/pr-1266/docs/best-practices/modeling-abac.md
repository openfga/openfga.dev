...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/best-practices/modeling-abac"
...
The simplest approach for boolean attributes is using the [Public Access](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/public-access.md) pattern. By assigning `user:*` to a relation, you effectively create a boolean flag that applies to all users.
...
For time-based, IP-based conditions and more, see the [Conditions documentation](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/conditions.md) for detailed examples.
...
- **Enumeration queries**: Stored-attribute patterns (relationship tuples) work fully with [ListObjects](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/perform-list-objects.md) and [ListUsers](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/perform-list-users.md) without requiring context. Conditional relationship tuples have limitations with these queries — if a condition parameter varies per user, ListUsers cannot supply the correct value for each candidate, and similarly for ListObjects with per-object attributes not stored in the tuple context. See [Conditions: Limitations](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/conditions.md#conditions-and-enumeration-queries-listobjects--listusers) for details
