...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/modeling/direct-access"
...
This article describes how to grant a [user](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-user) access to an [object](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-an-object) in [OpenFGA](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/fga.md).

**When to use**

Granting access with [relationship tuples](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relationship-tuple) is a core part of OpenFGA. Without relationship tuples, any [checks](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-check-request)\_ will fail. You should use:
...
Familiarize yourself with [OpenFGA Concepts](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md) to understand how to develop a relationship tuple and authorization model.

Assume that you have the following [authorization model](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-an-authorization-model).<br />You have a [type](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-type) called `document` that can have a `viewer` and/or an `editor`.
...
For an application to understand that **user x** has access to **document y**, it must provide OpenFGA that information with [relationship tuples](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relationship-tuple). Each relationship tuple has three basic parameters: a **[user](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-user)**, a **[relation](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relation)** and an **[object](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-an-object)**.

### 01. Create A Relationship Tuple

Below, you'll add a **[relationship tuple](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relationship-tuple)** to indicate that `bob` is an `editor` of `document:meeting_notes.doc` by adding the following:
...
Once you add that relationship tuple to OpenFGA, you can [check](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-check-request) if the relationship is valid by asking if bob is an editor of document:meeting\_notes.doc:
