...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/modeling/testing"
...
For complete details on the `.fga.yaml` store file format, see [Store File Format](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/store-file-format.md).
...
Check tests verify the results of the [check API](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/perform-check.md) calls to validate access requirements for a user. Each check verification has the following structure:

| Object                        | Description                                                                                                                                                   |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `user`                        | The user type and user id you are checking for access                                                                                                         |
| `object`                      | The object type and object id related to the user                                                                                                             |
| `context`                     | A set of tests for contextual parameters used to evaluate [conditions](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/conditions.md) |
...
A good test covers scenarios that specify every relation for every object type that your application will need to call the [list-objects API](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/perform-list-objects.md) for.
...
List users tests verify the results of the [list-users API](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/perform-list-users.md) to validate the users who or do not have access to an object
...
If you are using [Modular Models](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/modular-models.md), you need to use the `fga.mod` as the `model_file`.
...
- [More](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/cli.md)
