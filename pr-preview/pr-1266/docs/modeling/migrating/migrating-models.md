...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/modeling/migrating/migrating-models"
...
- [Models are immutable](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/getting-started/immutable-models.md).
...
- [This document](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/migrating/migrating-relations.md) describes an end-to-end example for that use case.
