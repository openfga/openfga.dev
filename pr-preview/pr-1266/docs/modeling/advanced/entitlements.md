...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/modeling/advanced/entitlements"
...
- How to model an entitlement use case in [OpenFGA](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/fga.md)
...
You need to know how to disallow granting direct relation to an object and requiring the user to have a relation with another object that would imply a relation with the first one. [Learn more →](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/building-blocks/direct-relationships.md)
...
![GitHub Pricing Plan](/pr-preview/pr-1266/assets/images/entitlements-image-pricing-github-2276507856dd07b091bcecc2376dde05.svg)
...
![GitHub PR Page with Draft Pull Request](/pr-preview/pr-1266/assets/images/entitlements-image-github-draft-pr-2ee031c09e3924b41681861e56aab2e7.svg) ![GitHub PR Page without Draft Pull Request](/pr-preview/pr-1266/assets/images/entitlements-image-github-no-draft-pr-785626465cfe1b8183918ee6bd3aefb1.svg)
...
![Image showing requirements](/pr-preview/pr-1266/assets/images/entitlements-requirements-fdd4048edc4d4b3b78785f4c0671e0b1.svg)
...
In this tutorial you are going to take a different approach to previous tutorials. You will start with a simple [authorization model](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-an-authorization-model), add [relationship tuples](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relationship-tuple) to represent some sample scenarios, and iterate until those scenarios return the results you expect.
...
First, you will [check](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-check-request) if `anne` is a member of `organization:alpha`. This is one of the relationship tuples you previously added, you will make sure OpenFGA can detect a relation in this case.
...
`access` [relation](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relation) was added to the configuration of the `feature` [type](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-type).

note

In this tutorial, you will find the phrases [direct relationship and implied relationship](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-are-direct-and-implied-relationships).

A _direct relationship_ R between user X and object Y means the relationship tuple (user=X, relation=R, object=Y) exists, and the OpenFGA authorization model for that relation allows this direct relationship (by use of [direct relationship type restrictions](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/configuration-language.md#direct-relationship-type-restrictions)).
...
So far so good. OpenFGA understood your query, but said that no [relation](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-relation) exists. That is because according to the configuration provided so far, there is no `access` relation between `anne` and `feature:issues`.
...
If you have already completed some of the other tutorials you might have encountered the modeling pattern of [parent-child objects](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/parent-child.md) which is modeled as such:
...
- a [direct relationship](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-are-direct-and-implied-relationships) via a relationship tuple: e.g. `{ "user": "user:x", "relation": "access", "object": "feature:y" }`
...
- how to model [**parent-child relationships**](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/modeling/parent-child.md) to indicate that a user having a relationship with a certain object implies having a relationship with another object in OpenFGA
- how to use [**the union operator**](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/configuration-language.md#the-union-operator) condition to indicate multiple possible paths for a relationship between two objects to be computed
- using [**direct relationship type restrictions**](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/configuration-language.md#direct-relationship-type-restrictions) in a OpenFGA authorization model, and how to block direct relationships by removing it
