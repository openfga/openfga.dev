...
canonical: "https://openfga.dev/pr-preview/pr-1266/docs/modeling/conditions"
...
Conditions allow you to model more complex authorization modeling scenarios involving attributes and can be used to represent some Attribute-based Access Control (ABAC) policies. Take a look at the [Conditions](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-condition) and [Conditional Relationship Tuples](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/concepts.md#what-is-a-conditional-relationship-tuple) concepts for a quick overview.
...
If you need both ListObjects and ListUsers to work for a level-based comparison, consider modeling the levels as a [type hierarchy using relationship tuples](https://openfga.dev/pr-preview/pr-1266/pr-preview/pr-1266/docs/best-practices/modeling-abac.md) instead of conditions.
