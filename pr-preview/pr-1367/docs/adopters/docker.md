...
canonical: "https://openfga.dev/pr-preview/pr-1367/docs/adopters/docker"
...
Docker ran OpenFGA in **parallel with the existing authorization system**: every permission check went to both engines, and results were compared. Once both systems consistently agreed, traffic was incrementally cut over to OpenFGA. The parallel-run pattern is one we recommend for any production migration — see the [adoption patterns guide](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/best-practices.md).
