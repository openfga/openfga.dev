...
canonical: "https://openfga.dev/pr-preview/pr-1367/docs/learn/rebac"
...
OpenFGA is a ReBAC engine in the [Zanzibar](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/learn/zanzibar.md) tradition. You define types and relations in a typed [DSL](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/configuration-language.md), write tuples like `(document:42, editor, user:alice)`, and call [check](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/interacting/relationship-queries.md) or `list-objects`.
...
- Pure attribute checks (department equals "engineering", region equals "EU") are better served by attributes — see [ABAC vs. ReBAC](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/learn/abac-vs-rebac.md). OpenFGA covers these with [conditions](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/modeling/conditions.md).
- Infrastructure or admission policy across many domains — see [policy engines](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/learn/policy-engine.md).
...
- [More](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/learn/rbac-vs-rebac.md)
