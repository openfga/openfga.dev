...
canonical: "https://openfga.dev/pr-preview/pr-1367/docs/fga"
...
- Support for multiple [stores](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-a-store) that allow authorization management in different environments (prod/testing/dev) and use cases (internal apps, external apps, infrastructure).
- Support for some ABAC scenarios with [Contextual Tuples](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/modeling/token-claims-contextual-tuples.md) and [Conditional Relationship Tuples](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/modeling/conditions.md).
...
- [A Command Line Interface tool](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/getting-started/cli.md) for managing OpenFGA stores, test models, import/export models, and data.
...
- [More](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/use-cases.md)

**Industries**

Sample models for healthcare, banking, e-commerce, HR, CRM, and LMS.

- [More](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/industries.md)

**Learn Authorization**

Zanzibar, ReBAC vs RBAC, ABAC vs ReBAC, and fine-grained authorization explained.

- [More](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/learn.md)
