...
canonical: "https://openfga.dev/pr-preview/pr-1367/docs/getting-started/perform-check"
...
This section will illustrate how to perform a [check](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-a-check-request) request to determine whether a [user](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-a-user) has a certain [relationship](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-a-relationship) with an [object](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-an-object).
...
If you want to check multiple user-object-relationship combinations in a single request, you can use the [Batch Check](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/api/service#Relationship%20Queries/BatchCheck) API endpoint. Batching authorization checks together in a single request significantly reduces overall network latency.
...
- [More](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/api/service#Relationship%20Queries/BatchCheck)
