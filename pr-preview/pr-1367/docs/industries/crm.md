...
canonical: "https://openfga.dev/pr-preview/pr-1367/docs/industries/crm"
...
**Inherited visibility on contacts.** Contacts don't carry their own ACL. They inherit from the parent account through [parent-child relationships](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/modeling/parent-child.md), so reassigning the account also reassigns visibility to its contacts.
...
| Contact inherits from account     | [parent-child relationships](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/modeling/parent-child.md)                       |
...
| Multi-tenant CRM SaaS             | tenant-scoped types, see [multi-tenant SaaS](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/use-cases/multi-tenant-saas.md) |
...
- **Pipeline-stage gating.** Use [conditions](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/modeling/conditions.md) so certain edits (e.g. discount approval) are only allowed when the opportunity's stage matches a runtime parameter.
