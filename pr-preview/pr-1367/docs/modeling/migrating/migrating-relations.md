...
canonical: "https://openfga.dev/pr-preview/pr-1367/docs/modeling/migrating/migrating-relations"
...
In the lifecycle of software development, you will need to make updates or changes to the [authorization model](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-an-authorization-model). In this guide, you will learn best practices for changing your existing authorization model. With these recommendations, you will minimize downtime and ensure your relationship models stay up to date.
...
- An [Object](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-an-object): represents an entity in the system. Users' relationships to it can be defined through relationship tuples and the authorization model
...
There are existing [relationship tuples](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-a-relationship-tuple) associated with editor relation.
