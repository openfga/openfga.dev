...
canonical: "https://openfga.dev/pr-preview/pr-1367/docs/modeling/contextual-time-based-authorization"
...
- A [Contextual Tuple](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-are-contextual-tuples): a tuple that can be added to a Check request, and only exists within the context of that particular request.
