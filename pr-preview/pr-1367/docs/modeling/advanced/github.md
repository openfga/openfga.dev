...
canonical: "https://openfga.dev/pr-preview/pr-1367/docs/modeling/advanced/github"
...
![Image showing github permission levels](/pr-preview/pr-1367/assets/images/github-permission-level-1059e9392f2d7126e8376f141d5bad84.svg)

At the end of this section we want to end up with the following permissions represented:

![Image showing permissions](/pr-preview/pr-1367/assets/images/github-01-14b7cc249174f7311e651e9541c4527b.svg)

To represent permissions in OpenFGA we use [relations](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-a-relation). For repository permissions we need to create the following [authorization model](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-an-authorization-model):
...
If we want to say `anne` is a reader of repository **repo:contoso/tooling** we create this [relationship tuple](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-a-relationship-tuple):
...
We can now [ask](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-a-check-request) OpenFGA "is `anne` a reader of repository **repo:contoso/tooling**?"
...
- the "readers": the set of users who are [directly related](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-are-direct-and-implied-relationships) to the repo as a "reader"
...
![Image showing permissions](/pr-preview/pr-1367/assets/images/github-02-2eaa2dc691d0378f661d8ce52dfab5d4.svg)

To add support for teams and memberships all we need to do is add this object to the OpenFGA [authorization model](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-an-authorization-model):
...
Let us now create a team, add a member to it and make it an admin of **repo:contoso/tooling** by adding the following [relationship tuples](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-is-a-relationship-tuple):
...
![Image showing permissions](/pr-preview/pr-1367/assets/images/github-03-7afa9c606e43a97e744eda1e1f201b02.svg)
...
![](/pr-preview/pr-1367/assets/images/github-04-6a9b8175f0c09f9ce3b843911c620693.svg)
...
- the "admins": the set of users who are [directly related](https://openfga.dev/pr-preview/pr-1367/pr-preview/pr-1367/docs/concepts.md#what-are-direct-and-implied-relationships) to the repo as an "admin"
...
- Whenever the value of this dropdown changes: ![Selecting new permission level from base permissions drop-down](/pr-preview/pr-1367/assets/images/github-org-base-permissions-drop-down-2952b06603835375e74da4bf2f8278f4.png)
