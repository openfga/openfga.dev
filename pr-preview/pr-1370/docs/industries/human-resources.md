...
canonical: "https://openfga.dev/pr-preview/pr-1370/docs/industries/human-resources"
...
| Multi-tenant HRIS SaaS              | tenant-scoped types, see [multi-tenant SaaS](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/use-cases/multi-tenant-saas.md) |
