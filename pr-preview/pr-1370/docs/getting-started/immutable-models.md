...
canonical: "https://openfga.dev/pr-preview/pr-1370/docs/getting-started/immutable-models"
...
You can list all the authorization models for a store using the [ReadAuthorizationModels](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/api/service#/Authorization%20Models/ReadAuthorizationModels) API. This endpoint returns the results sorted in reverse chronological order, as in the first model in the list is the latest model. By default, only the last 50 models are returned, but you can paginate across by passing in the appropriate `continuation_token`.

## How to target a particular model

Some endpoints relating to tuples ([Check](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/api/service#/Relationship%20Queries/Check), [ListObjects](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/api/service#/Relationship%20Queries/ListObjects), [ListUsers](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/api/service#/Relationship%20Queries/ListUsers), [Expand](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/api/service#/Relationship%20Queries/Expand), [Write](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/api/service#/Relationship%20Tuples/Write)) accept an `authorization_model_id`, which we strongly recommend passing, especially in production.
...
You can learn more about model migrations [here](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/modeling/migrating.md).
