...
canonical: "https://openfga.dev/pr-preview/pr-1370/docs/getting-started/update-tuples"
...
This is an introduction to adding and deleting _[relationship tuples](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/concepts.md#what-is-a-relationship-tuple)_.
...
3. You have [configured the _authorization model_](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/getting-started/configure-model.md).
...
- [More](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/api/service#Relationship%20Tuples/Write)

**Managing User Access**

Learn about how to give a user access to a particular object.

- [More](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/interacting/managing-user-access.md)
