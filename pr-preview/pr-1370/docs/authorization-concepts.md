...
canonical: "https://openfga.dev/pr-preview/pr-1370/docs/authorization-concepts"
...
See [Fine-Grained Authorization](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/learn/fine-grained-authorization.md) for the full explanation.
...
See [RBAC vs. ReBAC](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/learn/rbac-vs-rebac.md) for when roles run out and how OpenFGA models RBAC cleanly.
...
See [ABAC vs. ReBAC](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/learn/abac-vs-rebac.md) for how the two combine.

## What is Policy-Based Access Control?

Policy-Based Access Control (PBAC) manages authorization policies centrally, external to application code. Most ABAC implementations are also PBAC. OpenFGA's [model DSL](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/configuration-language.md) is itself a policy: committed to Git, reviewed via PR, deployed like any other code — see [Policy Engines vs. Relationship Engines](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/learn/policy-engine.md).

## What is Relationship-Based Access Control?

[Relationship-Based Access Control](https://en.wikipedia.org/wiki/Relationship-based_access_control) (ReBAC) makes access rules conditional on relationships between users and objects, and between objects themselves — _"a user can view a document if they have access to its parent folder"_. ReBAC is a superset of RBAC and natively covers ABAC scenarios when attributes are expressed as relationships. OpenFGA extends ReBAC with [Conditions](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/modeling/conditions.md) and [Contextual Tuples](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/modeling/token-claims-contextual-tuples.md) for the remaining attribute-driven cases.

See [What is ReBAC?](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/learn/rebac.md) for the full picture.
...
See [What is Zanzibar?](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/learn/zanzibar.md) for what the paper introduced and how OpenFGA maps to it.
...
- [More](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/getting-started.md)
