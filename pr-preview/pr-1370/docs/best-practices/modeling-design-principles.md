...
canonical: "https://openfga.dev/pr-preview/pr-1370/docs/best-practices/modeling-design-principles"
...
- **Team autonomy with modules**: Resource types owned by each application team can be maintained in independent [modules](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/modeling/modular-models.md). You can control which application can write to specific resource types through API credentials, providing better security boundaries.
...
For more details, see [Modeling Roles](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/best-practices/modeling-roles.md) and [Custom Roles](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/modeling/custom-roles.md).
...
- [More](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/modeling/custom-roles.md)
...
- [More](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/modeling/building-blocks.md)
