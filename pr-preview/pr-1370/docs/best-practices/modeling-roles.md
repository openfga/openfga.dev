...
canonical: "https://openfga.dev/pr-preview/pr-1370/docs/best-practices/modeling-roles"
...
4. **Functional Testing**: [Write tests](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/modeling/testing.md) to verify your model behaves as expected
