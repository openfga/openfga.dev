...
canonical: "https://openfga.dev/pr-preview/pr-1370/docs/interacting/managing-relationships-between-objects"
...
Assume that you have the following [authorization model](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/concepts.md#what-is-an-authorization-model)<br />* a `repo` type that can have a `admin` relation
...
For the current model, a [user](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/concepts.md#what-is-a-user) can be related as an `admin` to an [object](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/concepts.md#what-is-an-object) of [type](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/concepts.md#what-is-a-type) `repo`. If we wanted to have Anne be related to two repos, `repo:1` and `repo:2`, we would have to add two [relationship tuples](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/concepts.md#what-is-a-relationship-tuple), like so:
...
- [More](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/modeling/advanced/github.md)
