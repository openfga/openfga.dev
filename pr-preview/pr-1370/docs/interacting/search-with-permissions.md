...
canonical: "https://openfga.dev/pr-preview/pr-1370/docs/interacting/search-with-permissions"
...
2. Call [`/batch-check`](https://openfga.dev/pr-preview/pr-1370/pr-preview/pr-1370/docs/interacting/relationship-queries.md#batch-check) to check access for multiple objects in a single request.
...
1. Call the [OpenFGA changes API](https://openfga.dev/pr-preview/pr-1370/api/service#Relationship%20Tuples/ReadChanges).
...
1. Call the [OpenFGA List Objects API](https://openfga.dev/pr-preview/pr-1370/api/service#Relationship%20Queries/ListObjects). to get the list of all resources a user can access.
