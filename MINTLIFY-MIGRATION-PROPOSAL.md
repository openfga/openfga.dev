...
OpenAPI 3.0.3 document generated by `openfga/api`, pinned to an immutable upstream
revision and advanced through reviewed updates — no separate package, local
