// Auto-generated product configuration constants
 ...
 *
 * These constants are extracted from the v1.10.0 configuration schema.
...
/**
 * All product configuration default values in a single object
 */
...
/**
 * Type representing all available product configuration constants
 */
export type ProductConfigConstants = typeof PRODUCT_CONFIG_DEFAULTS;
