...
import { Auth0Icon, CodeIcon, FastIcon, GetInvolvedIcon, ModelIcon, OpenIcon } from '@components/icons/animations';
...
const features = [
  {
    id: 'model',
    icon: <AnimatedIcon animatedIcon={ ModelIcon } />,
  ...
  {
    id: 'code',
    icon: <AnimatedIcon animatedIcon={ CodeIcon } />, 
  ...
  {
    id: 'fast',
    icon: <AnimatedIcon animatedIcon={ FastIcon } />, 
    title: 'Blazing fast',
    content: [
  ...
  {
    id: 'open',
    icon: <AnimatedIcon animatedIcon={ OpenIcon } />, 
  ...
  {
    id: 'sponsored',
    icon: <AnimatedIcon animatedIcon={ Auth0Icon } />,  
  ...
  {
    id: 'contribute',
    icon: <AnimatedIcon animatedIcon={ GetInvolvedIcon } />, 
    title: 'Get Involved',
    content: [
