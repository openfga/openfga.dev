...
const features = [
  {
    id: 'model',
    icon: <AnimatedIcon element={ ModelIcon } />,
  ...
  {
    id: 'code',
    icon: <AnimatedIcon element={ CodeIcon } />, 
  ...
  {
    id: 'fast',
    icon: <AnimatedIcon element={ FastIcon } />, 
    title: 'Blazing fast',
    content: [
  ...
  {
    id: 'open',
    icon: <AnimatedIcon element={ OpenIcon } />, 
  ...
  {
    id: 'sponsored',
    icon: <AnimatedIcon element={ Auth0Icon } />,  
  ...
  {
    id: 'contribute',
    icon: <AnimatedIcon element={ GetInvolvedIcon } />, 
    title: 'Get Involved',
    content: [
