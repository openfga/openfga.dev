        ...
        <div className="row">
          <div className={clsx('col col--8 ' + styles.centerColumn)}>
            ...
            <p>
              ...
              <Link href="https://github.com/openfga/openfga.dev/issues" target="_blank" rel="noopener noreferrer">
                open an issue on GitHub
              </Link>
              .
            </p>
            <p>
              Otherwise, try navigating to the <Link href="https://openfga.dev">home page</Link>, and then find or
              search for the content you need from there.
            </p>
          </div>
