...
export default function Root({ children }: RootProps): JSX.Element {
  ...
  const hasMarkdownAlternate = ['/', '/project', '/community'].includes(normalizedRoutePath);
  ...
  const breadcrumbJsonLd = buildBreadcrumbJsonLd(normalizedRoutePath, siteConfig.url);
