...
Use the **Ask AI** widget in the site navigation to ask questions about OpenFGA. For AI-assisted implementation, install the [OpenFGA Best Practices Skill](https://github.com/openfga/agent-skills) or connect an MCP-compatible client to the [OpenFGA kapa.ai MCP server](https://openfga.mcp.kapa.ai). AI-generated answers may be inaccurate, so verify them against the project documentation and code.
