...
This is an introduction to adding and deleting _[relationship tuples](/docs/concepts#what-is-a-relationship-tuple)_.
...
<CardGroup>
  <Card title="Write API" href="/api-reference/relationship-tuples/add-or-delete-tuples-from-the-store">
