...
The CLI can import an [FGA Test file](/docs/modeling/testing) in a store. It writes the model included and imports the tuples in the fga test file.
...
<CardGroup>
  <Card title="Testing Models" href="/docs/modeling/testing">
