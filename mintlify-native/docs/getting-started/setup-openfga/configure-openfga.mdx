...
To learn how to run in Docker, check our [Docker documentation](./docker-setup#using-postgres).
...
To learn how to run in Docker, check our [Docker documentation](./docker-setup#using-mysql).
...
To learn how to run in Docker, check our [Docker documentation](./docker-setup#using-sqlite).
...
To learn how to run in Docker, check our [Docker documentation](./docker-setup#pre-shared-key-authentication).
...
To learn how to run in Docker, check our [Docker documentation](./docker-setup#oidc-authentication).
