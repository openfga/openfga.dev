...
Various releases of OpenFGA may have experimental features that can be enabled by providing the [`--experimentals`](./configuration) flag or the `experimentals` config.
