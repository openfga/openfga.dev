...
1. [Install the OpenFGA SDK Client](/docs/getting-started/install-sdk)
...
OpenFGA [supports](/docs/getting-started/setup-openfga/configure-openfga) tracing with OpenTelemetry.
