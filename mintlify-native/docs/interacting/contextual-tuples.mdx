...
<CardGroup>
  <Card title="Token Claims as Contextual Tuples" href="/docs/modeling/token-claims-contextual-tuples">
    Learn how to use token claims as contextual tuples.
  </Card>
  <Card title="Organization Context Authorization" href="/docs/modeling/organization-context-authorization">
    Learn about organization context-based authorization.
  </Card>
  <Card title="Conditional Relationships" href="/docs/modeling/conditions">
