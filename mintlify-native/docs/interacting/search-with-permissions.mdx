...
1. Call the [OpenFGA changes API](/api/service#Relationship%20Tuples/ReadChanges).
...
1. Call the [OpenFGA List Objects API](/api/service#Relationship%20Queries/ListObjects) to get the list of all resources a user can access.
