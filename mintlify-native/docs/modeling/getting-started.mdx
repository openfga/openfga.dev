...
Each of the previously defined types has a set of relations. [Relations](/docs/concepts#what-is-a-relation) are an important component in your model. After all, OpenFGA is a Relationship Based Access Control (ReBAC) system.
...
- any noun that is the \{noun\} of a "\{noun\} of a/an/the \{type\}" expression. **These are typically the Foreign Keys in a database.**
