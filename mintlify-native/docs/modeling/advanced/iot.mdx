...
The OpenFGA service is based on [Zanzibar](https://zanzibar.academy), a Relationship Based Access Control system. This means it relies on objects and user relations to perform authorization checks.
...
Notice that any reference to the [**direct relationship type restrictions**](/docs/configuration-language#direct-relationship-type-restrictions) has been removed. That indicates that a user cannot have a direct relationship with an object in this type.
