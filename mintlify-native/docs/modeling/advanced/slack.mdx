...
<h5 id="general-channel">`#general` channel</h5>
...
<h5 id="marketing-internal-channel">`#marketing-internal` channel</h5>
...
<h5 id="proj-marketing-campaign-channel">`#proj-marketing-campaign` channel</h5>
