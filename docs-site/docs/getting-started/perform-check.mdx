...
This section will illustrate how to perform a [check](/docs/concepts#what-is-a-check-request) request to determine whether a [user](/docs/concepts#what-is-a-user) has a certain [relationship](/docs/concepts#what-is-a-relationship) with an [object](/docs/concepts#what-is-an-object).
...
If you want to check multiple user-object-relationship combinations in a single request, you can use the [Batch Check](/api-reference/relationship-queries/send-a-list-of-%60check%60-operations-in-a-single-request) API endpoint. Batching authorization checks together in a single request significantly reduces overall network latency.
...
<CardGroup>
  ...
  <Card title="OpenFGA Batch Check API" href="/api-reference/relationship-queries/send-a-list-of-%60check%60-operations-in-a-single-request">
