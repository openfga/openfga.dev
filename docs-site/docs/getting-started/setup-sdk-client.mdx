...
The first step is to ensure that you have created a store by following [these steps](/docs/getting-started/create-store).
...
<Warning>
  If you are going to use this setup in production, you should enable TLS in your OpenFGA server. Please see the [Running OpenFGA in Production](/docs/best-practices/running-in-production).
</Warning>
