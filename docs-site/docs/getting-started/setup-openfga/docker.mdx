---
title: "\U0001F433 Setup OpenFGA with Docker"
sidebarTitle: Docker Setup Guide
description: Setting up an OpenFGA server with Docker
---

This article explains how to run your own OpenFGA server using Docker. To learn the different ways to configure OpenFGA check [Configuring OpenFGA](./configure-openfga).
