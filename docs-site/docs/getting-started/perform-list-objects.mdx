...
sidebarTitle: "Perform a List Objects Request"
---
...
This section describes how to perform a [list objects](/docs/concepts#what-is-a-list-objects-request) request. The List Objects API allows you to retrieve all [objects](/docs/concepts#what-is-an-object) of a specified [type](/docs/concepts#what-is-a-type) that a [user](/docs/concepts#what-is-a-user) has a given [relationship](/docs/concepts#what-is-a-relationship) with. This can be used in scenarios like displaying all documents a user can read or listing resources a user can manage.
...
<CardGroup>
  <Card title="OpenFGA List Objects API" href="/api-reference/relationship-queries/list-all-objects-of-the-given-type-that-the-user-has-a-relation-with">
    Read the List Objects API documentation and see how it works.
  </Card>

  <Card title="OpenFGA Streamed List Objects API" href="/api-reference/relationship-queries/stream-all-objects-of-the-given-type-that-the-user-has-a-relation-with">
