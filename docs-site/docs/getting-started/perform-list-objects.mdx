...
<CardGroup>
  <Card title="OpenFGA List Objects API" href="/api/service/relationship-queries/list-all-objects-of-the-given-type-that-the-user-has-a-relation-with">
    Read the List Objects API documentation and see how it works.
  </Card>

  <Card title="OpenFGA Streamed List Objects API" href="/api/service/relationship-queries/stream-all-objects-of-the-given-type-that-the-user-has-a-relation-with">
