...
sidebarTitle: "Configure Authorization Model"
description: "Configuring authorization model for a store"
---

import { OpenFGACodeBlock } from '/snippets/OpenFGACodeBlock.jsx';

This article explains how to configure an [authorization model](/docs/concepts#what-is-an-authorization-model) for a [store](/docs/concepts#what-is-a-store) in an OpenFGA server.
...
\x20   define writer: [user]
\x20   define owner: [user]`} />

To configure authorization model, we can invoke the [write authorization models API](/api-reference/authorization-models/create-a-new-authorization-model).
...
<Tabs>
    ...
    <Accordion title="Initialize the SDK">
      ...
      async def main():
          ...
          async with OpenFgaClient(configuration) as fga_client:
              # Place the write request below here.
              pass
  ...
  <Tab title="CLI">
    <Accordion title="Set FGA_API_URL according to the service you are using (e.g. https://api.fga.example)">
      ```bash
