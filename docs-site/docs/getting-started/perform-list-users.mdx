...
sidebarTitle: "Perform a List Users Request"
---
...
This section will illustrate how to perform a [list users](/docs/concepts#what-is-a-list-users-request) request. The List Users call allows you to retrieve a list of [users](/docs/concepts#what-is-a-user) that have a specific [relationship](/docs/concepts#what-is-a-relationship) with a given [object](/docs/concepts#what-is-an-object). This can be used in scenarios such as retrieving users who have access to a resource or managing members in a group.
...
type document
\x20 relations
\x20   define viewer: [ group#member ]`} />
...
<CardGroup>
  <Card title="OpenFGA List Users API" href="/api-reference/relationship-queries/list-the-users-matching-the-provided-filter-who-have-a-certain-relation-to-a-particular-type">
