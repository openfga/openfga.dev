...
<Accordion title="Examples and details" id="what-is-a-check-request-examples">
  Check requests use the `check` methods in the OpenFGA SDKs ([JavaScript SDK](https://www.npmjs.com/package/@openfga/sdk)/[Go SDK](https://github.com/openfga/go-sdk)/[.NET SDK](https://www.nuget.org/packages/OpenFga.Sdk)) by manually calling the [check endpoint](/api/service/relationship-queries/check-whether-a-user-is-authorized-to-access-an-object) using curl or in your code. The check endpoint responds with `{ "allowed": true }` if a relationship exists, and with `{ "allowed": false }` if the relationship does not.

  For example, the following will check whether `anne` of type user has a `viewer` relation to `document:new-roadmap`:

  <CheckRequestViewer user={'user:anne'} relation={'viewer'} object={'document:new-roadmap'} allowed={true} />

  For more information, see the [Relationship Queries page](/docs/interacting/relationship-queries) and the official [Check API Reference](/api/service/relationship-queries/check-whether-a-user-is-authorized-to-access-an-object).
</Accordion>
...
<Accordion title="Examples and details" id="what-is-a-list-objects-request-examples">
  List objects requests are completed using the `listobjects` methods in the OpenFGA SDKs ([JavaScript SDK](https://www.npmjs.com/package/@openfga/sdk)/[Go SDK](https://github.com/openfga/go-sdk)/[.NET SDK](https://www.nuget.org/packages/OpenFga.Sdk)) by manually calling the [list objects endpoint](/api/service/relationship-queries/list-all-objects-of-the-given-type-that-the-user-has-a-relation-with) using curl or in your code.
  ...
  For more information, see the [Relationship Queries page](/docs/interacting/relationship-queries) and the [List Objects API Reference](/api/service/relationship-queries/list-all-objects-of-the-given-type-that-the-user-has-a-relation-with).
</Accordion>
...
<Accordion title="Examples and details" id="what-is-a-list-users-request-examples">
  List users requests are completed using the relevant `ListUsers` method in SDKs, the `fga query list-users` command in the CLI, or by manually calling the [ListUsers endpoint](/api/service/relationship-queries/list-the-users-matching-the-provided-filter-who-have-a-certain-relation-to-a-particular-type) using curl or in your code.
  ...
  For more information, see the [ListUsers API Reference](/api/service/relationship-queries/list-the-users-matching-the-provided-filter-who-have-a-certain-relation-to-a-particular-type).
</Accordion>
...
<Accordion title="Examples and details" id="what-are-contextual-tuples-examples">
  ...
  For more information, see [Contextual and Time-Based Authorization](/docs/modeling/contextual-time-based-authorization), [Authorization Through Organization Context](/docs/modeling/organization-context-authorization) and [Check API Request Documentation](/api/service/relationship-queries/check-whether-a-user-is-authorized-to-access-an-object).
</Accordion>
