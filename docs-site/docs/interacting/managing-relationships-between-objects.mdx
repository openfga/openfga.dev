...
sidebarTitle: "Manage Relationships Between Objects"
---
...
Assume that you have the following [authorization model](/docs/concepts#what-is-an-authorization-model)
...
For the current model, a [user](/docs/concepts#what-is-a-user) can be related as an `admin` to an [object](/docs/concepts#what-is-an-object) of [type](/docs/concepts#what-is-a-type) `repo`. If we wanted to have Anne be related to two repos, `repo:1` and `repo:2`, we would have to add two [relationship tuples](/docs/concepts#what-is-a-relationship-tuple), like so:
