...
1. Call the [OpenFGA changes API](/api/service/relationship-tuples/return-a-list-of-all-the-tuple-changes).
...
1. Call the [OpenFGA List Objects API](/api/service/relationship-queries/list-all-objects-of-the-given-type-that-the-user-has-a-relation-with). to get the list of all resources a user can access.
