...
sidebarTitle: "Task-Based Authorization"
---
...
type tool
\x20 relations
\x20   define can_call: [task, task:*]
type tool_resource
\x20 relations
\x20   define tool: [tool]
\x20   define can_call: [task] or can_call from tool`} />
...
\x20   # relations for users
\x20   define owner: [user]
\x20   define member: [user]
\x20   # relations for tasks
\x20   define read: [task]
\x20   define write: [task]
\x20   define delete: [task]
\x20   # permissions for users
\x20   define can_delete: delete or owner or admin from organization
\x20   define can_edit: write or owner or admin from organization
\x20   define can_read: read or can_edit or member from organization
\x20   define can_create_ticket: can_edit
type ticket
\x20 relations
...
\x20   define write: [task]
\x20   define delete: [task]
\x20   define can_delete: owner or delete or can_delete from project
\x20   define can_edit: owner or write or can_edit from project
\x20   define can_read: read or write or can_read from project`} />
...
type agent
\x20 relations
\x20   define task: [task]
type session
\x20 relations
\x20   define task: [task]
type tool
\x20 relations
\x20   define can_call: [task, session#task, agent#task]`} />
...
type tool
\x20 relations
\x20   define can_call: [task, task with expiration, task with max_call_count]
...
\x20 current_tool_count < max_tool_calls
}`} />
...
type tool
\x20 relations
\x20   define calling_agent: [agent]
\x20   define can_call: [task] and task from calling_agent`} />
