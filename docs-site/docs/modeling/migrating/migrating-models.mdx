...
description: Learn how to migrate OpenFGA authorization models, including adding, removing, and renaming types and relations.
sidebarTitle: "Migrating Models"
---
...
- [Models are immutable](/docs/getting-started/immutable-models).
...
- [This document](/docs/modeling/migrating/migrating-relations) describes an end-to-end example for that use case.
