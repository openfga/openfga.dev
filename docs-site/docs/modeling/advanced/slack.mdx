...
To verify, we can issue [check request](/docs/concepts#what-is-a-check-request) to verify it is working as expected.
...
- were introduced to [fine grain authentication](/docs/authorization-concepts#what-is-fine-grained-authorization) and OpenFGA.
