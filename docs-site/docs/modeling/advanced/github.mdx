---
sidebarTitle: "GitHub"
title: "Modeling GitHub permissions with OpenFGA"
...
- Indicate [relationships](/docs/concepts#what-is-a-relationship) between a group of **[users](/docs/concepts#what-is-a-user)** and an **[object](/docs/concepts#what-is-an-object)**. See [Modeling User Groups](/docs/modeling/user-groups) for more details.
  Used here to indicate that all members of an organization are repository admins on the organization.
- Modeling **concentric relationship** to have a certain [relation](/docs/concepts#what-is-a-relation) on an object imply another relation on the same object. See [Modeling Concepts: Concentric Relationships](/docs/modeling/building-blocks/concentric-relationships) for more.
...
<h2 id="modeling-githubs-permissions">Modeling GitHub's permissions</h2>
...
To represent permissions in OpenFGA we use [relations](/docs/concepts#what-is-a-relation). For repository permissions we need to create the following [authorization model](/docs/concepts#what-is-an-authorization-model):
...
If we want to say `anne` is a reader of repository **repo:contoso/tooling** we create this [relationship tuple](/docs/concepts#what-is-a-relationship-tuple):
...
We can now [ask](/docs/concepts#what-is-a-check-request) OpenFGA "is `anne` a reader of repository **repo:contoso/tooling**?"
...
- the "readers": the set of users who are [directly related](/docs/concepts#what-are-direct-and-implied-relationships) to the repo as a "reader"
...
To add support for teams and memberships all we need to do is add this object to the OpenFGA [authorization model](/docs/concepts#what-is-an-authorization-model):
...
Let us now create a team, add a member to it and make it an admin of **repo:contoso/tooling** by adding the following [relationship tuples](/docs/concepts#what-is-a-relationship-tuple):
...
The last relationship tuple introduces a new **OpenFGA** concept. A **[userset](/docs/concepts#what-is-a-user)**. When the value of a user is formatted like this **type:objectId#relation**, OpenFGA will automatically expand the userset into all its individual user identifiers:
...
Let's say we have a **protocols** team that is part of the **engineering**. The simplest way to achieve the aforementioned requirement is just adding this [relationship tuple](/docs/concepts#what-is-a-relationship-tuple):
...
![Diagram showing GitHub organization base permissions](./assets/github-04.svg)
...
- the "admins": the set of users who are [directly related](/docs/concepts#what-are-direct-and-implied-relationships) to the repo as an "admin"
