...
- using [**direct relationship type restrictions**](/docs/configuration-language#direct-relationship-type-restrictions) in a OpenFGA authorization model, and how to block direct relationships by removing it
