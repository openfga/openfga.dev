...
<h3 id="01-update-the-athorization-model-to-allow-a-parent-relationship-between-folder-and-document">01. Update the Authorization Model to allow a parent relationship between folder and document</h3>
