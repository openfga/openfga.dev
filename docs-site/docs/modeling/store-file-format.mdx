...
sidebarTitle: "Store File Format"
...
<h4 id="option-a-external-file-reference-1">Option A: External File Reference</h4>
```yaml
...
<h3 id="global--test-specific-data">Global + Test-Specific Data</h3>
