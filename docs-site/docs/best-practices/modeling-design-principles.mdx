...
sidebarTitle: "Authorization Model Design Principles"
...
<Accordion title="What to avoid: The overly generic model">
...
<h3 id="use-specific-types-not-a-generic-resource">Use Specific Types, Not a Generic "Resource"</h3>
...
<Accordion title="What to avoid: The generic resource type">
