...
sidebarTitle: "Microservices Authorization with OpenFGA"
---
...
type project
\x20 relations
\x20   define team: [team]
\x20   define can_view: member from team
\x20   define can_edit: member from team

type document
\x20 relations
\x20   define project: [project]
\x20   define can_view: can_view from project
\x20   define can_edit: can_edit from project`} />
