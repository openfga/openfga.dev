---
title: "Multi-Tenant SaaS Authorization"
...
sidebarTitle: "Multi-Tenant SaaS Authorization with OpenFGA"
---
...
<OpenFGACodeBlock code={`type user

type group
\x20 relations
\x20   define member: [user, group#member]

type role
\x20 relations
\x20   define assignee: [user, role#assignee, group#member]

type organization
\x20 relations
\x20   define admin: [user, role#assignee]
\x20   define billing_manager: [role#assignee] or admin
\x20   define document_manager: [role#assignee] or admin

\x20   define can_invite_user: admin
\x20   define can_edit_billing: billing_manager
\x20   define can_create_document: document_manager

type document
\x20 relations
\x20   define organization: [organization]
\x20   define editor: document_manager from organization
\x20   define viewer: document_manager from organization

\x20   define can_view: viewer or editor
\x20   define can_edit: editor`} />
