export const BatchCheckRequestViewer = ({ checks, authorizationModelId, skipSetup, allowedLanguages, consistency }) => {
  ...
  const buildCode = (lang) =>
    runtime.buildRequestCode(lang, 'BatchCheckRequestViewer', { checks, authorizationModelId, consistency });
