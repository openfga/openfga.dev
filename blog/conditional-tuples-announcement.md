...
You'll get the following results for the [Check](https://openfga.dev/api/service/relationship-queries/check-whether-a-user-is-authorized-to-access-an-object) operations below:
...
You'll get the following results for the [ListObjects](https://openfga.dev/api/service/relationship-queries/list-all-objects-of-the-given-type-that-the-user-has-a-relation-with) operations below:
...
- The [Expand API](https://openfga.dev/api/service/relationship-queries/expand-all-relationships-in-userset-tree-format-and-following-userset-rewrite-rules-useful-to-reason-about-and-debug-a-certain-relationship) does not consider conditions.
